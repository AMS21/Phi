...
set(_phi_noexcept_flags_supported CACHE INTERNAL "")
foreach(_test ${phi_noexcept_flags})
  ...
  if(PHI_HAS_FLAG_${_testName})
    set(_phi_noexcept_flags_supported
        ${_phi_noexcept_flags_supported}${PHI_FLAG_PREFIX_CHAR}${_test}
        CACHE INTERNAL "")
  endif()
endforeach(_test)
...
function(phi_target_disable_exceptions)
  ...
  foreach(flag ${_phi_noexcept_flags_supported})
