...
elseif(${CMAKE_SYSTEM_NAME} STREQUAL "Emscripten")
  set(PHI_OS_EMSCRIPTEN 1)
else()
  message(WARNING "[Phi]: Unsupported operating system or environment: ${CMAKE_SYSTEM_NAME}")
  return()
endif()
...
elseif(${SIZEOF_VOID_PTR} STREQUAL "8")
  ...
  message(FATAL_ERROR "[Phi]: Unsupported architecture")
  return()
endif()
...
elseif(MSVC)
  ...
  elseif(MSVC_VERSION EQUAL 1928)
    ...
    message(WARNING "[Phi]: Unknown version of MSVC used. MSVC_VERSION=${MSVC_VERSION}")
  endif()
else()
  message(FATAL_ERROR "[Phi]: Unsupported compiler")
  return()
endif()
...
if(NOT ProcCount EQUAL 0)
  ...
  message(WARNING "[Phi]: Failed to get processor count")
