...
void test_is_unsafe_floating_point()
{
    ...
    STATIC_REQUIRE(phi::is_unsafe_floating_point<const T>::value);
    STATIC_REQUIRE(phi::is_unsafe_floating_point<volatile T>::value);
    STATIC_REQUIRE(phi::is_unsafe_floating_point<const volatile T>::value);

#if PHI_HAS_FEATURE_VARIABLE_TEMPLATE()
    STATIC_REQUIRE(phi::is_unsafe_floating_point_v<T>);
    STATIC_REQUIRE(phi::is_unsafe_floating_point_v<const T>);
    STATIC_REQUIRE(phi::is_unsafe_floating_point_v<volatile T>);
    STATIC_REQUIRE(phi::is_unsafe_floating_point_v<const volatile T>);
#endif
}
