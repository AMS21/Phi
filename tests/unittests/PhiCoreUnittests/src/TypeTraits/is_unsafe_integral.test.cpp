...
void test_is_unsafe_integral()
{
    ...
    STATIC_REQUIRE(phi::is_unsafe_integral<const T>::value);
    STATIC_REQUIRE(phi::is_unsafe_integral<volatile T>::value);
    STATIC_REQUIRE(phi::is_unsafe_integral<const volatile T>::value);

#if PHI_HAS_FEATURE_VARIABLE_TEMPLATE()
    STATIC_REQUIRE(phi::is_unsafe_integral_v<T>);
    STATIC_REQUIRE(phi::is_unsafe_integral_v<const T>);
    STATIC_REQUIRE(phi::is_unsafe_integral_v<volatile T>);
    STATIC_REQUIRE(phi::is_unsafe_integral_v<const volatile T>);
#endif
}
...
void test_is_not_unsafe_integral()
{
    ...
    STATIC_REQUIRE_FALSE(phi::is_unsafe_integral<const T>::value);
    STATIC_REQUIRE_FALSE(phi::is_unsafe_integral<volatile T>::value);
    STATIC_REQUIRE_FALSE(phi::is_unsafe_integral<const volatile T>::value);

#if PHI_HAS_FEATURE_VARIABLE_TEMPLATE()
    STATIC_REQUIRE_FALSE(phi::is_unsafe_integral_v<T>);
    STATIC_REQUIRE_FALSE(phi::is_unsafe_integral_v<const T>);
    STATIC_REQUIRE_FALSE(phi::is_unsafe_integral_v<volatile T>);
    STATIC_REQUIRE_FALSE(phi::is_unsafe_integral_v<const volatile T>);
#endif
}
...
TEST_CASE("is_unsafe_integral")
{
    ...
    test_is_not_unsafe_integral<Struct>();
