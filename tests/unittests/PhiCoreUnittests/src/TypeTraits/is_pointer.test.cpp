...
TEST_CASE("is_pointer")
{
    ...
    test_is_not_pointer<phi::FloatingPoint<float>>();
    test_is_not_pointer<phi::FloatingPoint<double>>();
    test_is_not_pointer<phi::FloatingPoint<long double>>();

    test_is_not_pointer<std::vector<int>>();
    test_is_not_pointer<phi::ScopePtr<int>>();
