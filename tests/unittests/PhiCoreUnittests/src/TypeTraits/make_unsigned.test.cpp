...
TEST_CASE("make_unsigned")
{
    ...
    test_make_unsigned<Struct>();
    test_make_unsigned<TemplateClass<void>>();
    test_make_unsigned<TemplateClass<int>>();
    test_make_unsigned<TemplateClass<Class>>();
    test_make_unsigned<TemplateClass<incomplete_type>>();
    test_make_unsigned<TemplateStruct<void>>();
    test_make_unsigned<TemplateStruct<int>>();
    test_make_unsigned<TemplateStruct<Class>>();
    test_make_unsigned<TemplateStruct<incomplete_type>>();
    test_make_unsigned<VariadicTemplateClass<>>();
    test_make_unsigned<VariadicTemplateClass<void>>();
    test_make_unsigned<VariadicTemplateClass<int>>();
    test_make_unsigned<VariadicTemplateClass<Class>>();
    test_make_unsigned<VariadicTemplateClass<incomplete_type>>();
    test_make_unsigned<VariadicTemplateClass<int, void, Class, volatile char[]>>();
    test_make_unsigned<VariadicTemplateStruct<>>();
    test_make_unsigned<VariadicTemplateStruct<void>>();
    test_make_unsigned<VariadicTemplateStruct<int>>();
    test_make_unsigned<VariadicTemplateStruct<Class>>();
    test_make_unsigned<VariadicTemplateStruct<incomplete_type>>();
    test_make_unsigned<VariadicTemplateStruct<int, void, Class, volatile char[]>>();
