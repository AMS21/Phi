...
TEMPLATE_TEST_CASE("Vector2 templated", "[Math][Vector2]", char, signed char, unsigned char, short, unsigned short, int, unsigned, long, unsigned long, long long, unsigned long long, float, double, long double, phi::i8, phi::i16, phi::i32, phi::i64, phi::u8, phi::u16, phi::u32, phi::u64, phi::FloatingPoint<float>, phi::FloatingPoint<double>, phi::FloatingPoint<long double>)
{
