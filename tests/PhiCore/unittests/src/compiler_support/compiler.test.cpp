...
TEST_CASE("PHI_CURRENT_COMPILER_VERSION_STR")
{
    STATIC_REQUIRE(phi::string_equals(
            PHI_CURRENT_COMPILER_VERSION_STR(),
            PHI_STRINGIFY(PHI_CURRENT_COMPILER_VERSION_MAJOR()) "." PHI_STRINGIFY(
                    PHI_CURRENT_COMPILER_VERSION_MINOR()) "." PHI_STRINGIFY(PHI_CURRENT_COMPILER_VERSION_PATCH())));
}
