...
TEST_CASE("is_bool")
{
    ...
    test_is_not_bool<incomplete_variadic_template<>>();
    test_is_not_bool<incomplete_variadic_template<void>>();
    test_is_not_bool<incomplete_variadic_template<int>>();
    test_is_not_bool<incomplete_variadic_template<class_type>>();
    test_is_not_bool<incomplete_variadic_template<incomplete_type>>();
    test_is_not_bool<incomplete_variadic_template<int, void, class_type, volatile char[]>>();
