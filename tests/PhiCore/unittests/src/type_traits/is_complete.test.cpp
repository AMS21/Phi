...
TEST_CASE("is_complete")
{
    ...
    test_is_complete<enum_type>();
    test_is_complete<enum_signed>();
    test_is_complete<enum_unsigned>();
    test_is_complete<enum_class>();
    test_is_complete<enum_struct>();
    ...
    test_is_not_complete<IncompleteVariadicTemplate<class_type>>();
    test_is_not_complete<IncompleteVariadicTemplate<incomplete_type>>();
    test_is_not_complete<IncompleteVariadicTemplate<int, void, class_type, volatile char[]>>();
