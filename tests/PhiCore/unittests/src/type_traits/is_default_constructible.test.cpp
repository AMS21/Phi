...
#    endif
    ...
    TEST_TYPE_TRAITS_TYPE_DEFS(phi::is_default_constructible<T>);
    TEST_TYPE_TRAITS_TYPE_DEFS(phi::is_not_default_constructible<T>);
...
TEST_CASE("is_default_constructible")
{
    ...
    test_is_default_constructible<Template<IncompleteType>>();
    ...
    test_is_default_constructible<VariadicTemplate<IncompleteType>>();
    test_is_default_constructible<VariadicTemplate<int, void, Class, volatile char[]>>();
    test_is_default_constructible<PublicDerivedFromTemplate<Base>>();
    test_is_default_constructible<PublicDerivedFromTemplate<Derived>>();
    test_is_default_constructible<PublicDerivedFromTemplate<Class>>();
    test_is_default_constructible<PrivateDerivedFromTemplate<Base>>();
    test_is_default_constructible<PrivateDerivedFromTemplate<Derived>>();
    test_is_default_constructible<PrivateDerivedFromTemplate<Class>>();
    test_is_default_constructible<ProtectedDerivedFromTemplate<Base>>();
    test_is_default_constructible<ProtectedDerivedFromTemplate<Derived>>();
    test_is_default_constructible<ProtectedDerivedFromTemplate<Class>>();
    ...
    test_is_default_constructible<BitZero>();
    test_is_default_constructible<BitOne>();
    ...
    test_is_not_default_constructible<AbstractTemplate<IncompleteType>>();
#endif
