...
TEST_CASE("extent")
{
    ...
    test_extent<Template<IncompleteType>>();
    ...
    test_extent<VariadicTemplate<IncompleteType>>();
    test_extent<VariadicTemplate<int, void, Class, volatile char[]>>();
    test_extent<PublicDerivedFromTemplate<Base>>();
    test_extent<PublicDerivedFromTemplate<Derived>>();
    test_extent<PublicDerivedFromTemplate<Class>>();
    test_extent<PrivateDerivedFromTemplate<Base>>();
    test_extent<PrivateDerivedFromTemplate<Derived>>();
    test_extent<PrivateDerivedFromTemplate<Class>>();
    test_extent<ProtectedDerivedFromTemplate<Base>>();
    test_extent<ProtectedDerivedFromTemplate<Derived>>();
    test_extent<ProtectedDerivedFromTemplate<Class>>();
    test_extent<Union>();
    ...
    test_extent<AbstractTemplate<IncompleteType>>();
    test_extent<Final>();
    ...
    test_extent<IncompleteVariadicTemplate<IncompleteType>>();
