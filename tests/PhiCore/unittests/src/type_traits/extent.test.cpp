...
TEST_CASE("extent")
{
    ...
    test_extent<enum_type>();
    test_extent<enum_signed>();
    test_extent<enum_unsigned>();
    test_extent<enum_class>();
    test_extent<enum_struct>();
    ...
    test_extent<IncompleteVariadicTemplate<class_type>>();
    test_extent<IncompleteVariadicTemplate<incomplete_type>>();
    test_extent<IncompleteVariadicTemplate<int, void, class_type, volatile char[]>>();
