...
TEST_CASE("is_destructible")
{
    ...
    test_is_destructible<Template<incomplete_type>>();
    ...
    test_is_destructible<VariadicTemplate<incomplete_type>>();
    test_is_destructible<VariadicTemplate<int, void, Class, volatile char[]>>();
    test_is_destructible<PublicDerviedFromTemplate<Base>>();
    test_is_destructible<PublicDerviedFromTemplate<Derived>>();
    test_is_destructible<PublicDerviedFromTemplate<Class>>();
    test_is_destructible<PrivateDerviedFromTemplate<Base>>();
    test_is_destructible<PrivateDerviedFromTemplate<Derived>>();
    test_is_destructible<PrivateDerviedFromTemplate<Class>>();
    test_is_destructible<ProtectedDerviedFromTemplate<Base>>();
    test_is_destructible<ProtectedDerviedFromTemplate<Derived>>();
    test_is_destructible<ProtectedDerviedFromTemplate<Class>>();
    ...
    test_is_destructible<AbstractTemplate<incomplete_type>>();
