...
TEST_CASE("is_object")
{
    ...
    test_is_object<Template<incomplete_type>>();
    ...
    test_is_object<VariadicTemplate<incomplete_type>>();
    test_is_object<VariadicTemplate<int, void, Class, volatile char[]>>();
    test_is_object<PublicDerviedFromTemplate<Base>>();
    test_is_object<PublicDerviedFromTemplate<Derived>>();
    test_is_object<PublicDerviedFromTemplate<Class>>();
    test_is_object<PrivateDerviedFromTemplate<Base>>();
    test_is_object<PrivateDerviedFromTemplate<Derived>>();
    test_is_object<PrivateDerviedFromTemplate<Class>>();
    test_is_object<ProtectedDerviedFromTemplate<Base>>();
    test_is_object<ProtectedDerviedFromTemplate<Derived>>();
    test_is_object<ProtectedDerviedFromTemplate<Class>>();
    ...
    test_is_object<IncompleteTemplate<incomplete_type>>();
