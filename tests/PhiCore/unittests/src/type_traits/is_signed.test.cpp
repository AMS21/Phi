...
TEST_CASE("is_signed")
{
    ...
    test_is_not_signed<enum_type>();
    test_is_not_signed<enum_signed>();
    test_is_not_signed<enum_unsigned>();
    test_is_not_signed<enum_class>();
    test_is_not_signed<enum_struct>();
    ...
    test_is_not_signed<IncompleteVariadicTemplate<class_type>>();
    test_is_not_signed<IncompleteVariadicTemplate<incomplete_type>>();
    test_is_not_signed<IncompleteVariadicTemplate<int, void, class_type, volatile char[]>>();
