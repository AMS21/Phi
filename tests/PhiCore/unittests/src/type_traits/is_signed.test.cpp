...
TEST_CASE("is_signed")
{
    ...
    test_is_not_signed<Template<incomplete_type>>();
    ...
    test_is_not_signed<VariadicTemplate<incomplete_type>>();
    test_is_not_signed<VariadicTemplate<int, void, Class, volatile char[]>>();
    test_is_not_signed<PublicDerviedFromTemplate<Base>>();
    test_is_not_signed<PublicDerviedFromTemplate<Derived>>();
    test_is_not_signed<PublicDerviedFromTemplate<Class>>();
    test_is_not_signed<PrivateDerviedFromTemplate<Base>>();
    test_is_not_signed<PrivateDerviedFromTemplate<Derived>>();
    test_is_not_signed<PrivateDerviedFromTemplate<Class>>();
    test_is_not_signed<ProtectedDerviedFromTemplate<Base>>();
    test_is_not_signed<ProtectedDerviedFromTemplate<Derived>>();
    test_is_not_signed<ProtectedDerviedFromTemplate<Class>>();
    ...
    test_is_not_signed<AbstractTemplate<incomplete_type>>();
    ...
    test_is_not_signed<IncompleteTemplate<incomplete_type>>();
    ...
    test_is_not_signed<IncompleteVariadicTemplate<incomplete_type>>();
