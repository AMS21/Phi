...
TEST_CASE("is_pointer")
{
    ...
    test_is_pointer<IncompleteType*>();
    ...
    test_is_not_pointer<Template<IncompleteType>>();
    ...
    test_is_not_pointer<VariadicTemplate<IncompleteType>>();
    test_is_not_pointer<VariadicTemplate<int, void, Class, volatile char[]>>();
    test_is_not_pointer<PublicDerivedFromTemplate<Base>>();
    test_is_not_pointer<PublicDerivedFromTemplate<Derived>>();
    test_is_not_pointer<PublicDerivedFromTemplate<Class>>();
    test_is_not_pointer<PrivateDerivedFromTemplate<Base>>();
    test_is_not_pointer<PrivateDerivedFromTemplate<Derived>>();
    test_is_not_pointer<PrivateDerivedFromTemplate<Class>>();
    test_is_not_pointer<ProtectedDerivedFromTemplate<Base>>();
    test_is_not_pointer<ProtectedDerivedFromTemplate<Derived>>();
    test_is_not_pointer<ProtectedDerivedFromTemplate<Class>>();
    test_is_not_pointer<Union>();
    test_is_not_pointer<NonEmptyUnion>();
    test_is_not_pointer<Empty>();
    test_is_not_pointer<NotEmpty>();
    test_is_not_pointer<BitZero>();
    test_is_not_pointer<BitOne>();
    ...
    test_is_not_pointer<AbstractTemplate<IncompleteType>>();
    ...
    test_is_not_pointer<IncompleteType>();
    ...
    test_is_not_pointer<IncompleteTemplate<IncompleteType>>();
    ...
    test_is_not_pointer<IncompleteVariadicTemplate<IncompleteType>>();
