...
TEST_CASE("is_pointer")
{
    ...
    test_is_not_pointer<final_type>();
    test_is_not_pointer<enum_type>();
    test_is_not_pointer<enum_signed>();
    test_is_not_pointer<enum_unsigned>();
    test_is_not_pointer<enum_class>();
    test_is_not_pointer<enum_struct>();
    ...
    test_is_not_pointer<IncompleteVariadicTemplate<class_type>>();
    test_is_not_pointer<IncompleteVariadicTemplate<incomplete_type>>();
    test_is_not_pointer<IncompleteVariadicTemplate<int, void, class_type, volatile char[]>>();
