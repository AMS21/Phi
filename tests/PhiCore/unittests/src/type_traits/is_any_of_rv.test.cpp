...
{
    STATIC_REQUIRE(phi::is_any_of_rv<TypeT, ArgsT...>::value);

#if PHI_HAS_FEATURE_VARIABLE_TEMPLATE()
    STATIC_REQUIRE(phi::is_any_of_rv_v<TypeT, ArgsT...>);
#endif

    TEST_TYPE_TRAITS_TYPE_DEFS(phi::is_any_of_rv<TypeT, ArgsT...>);
}

template <typename TypeT, typename... ArgsT>
void test_is_not_any_of_rv()
{
    STATIC_REQUIRE_FALSE(phi::is_any_of_rv<TypeT, ArgsT...>::value);

#if PHI_HAS_FEATURE_VARIABLE_TEMPLATE()
    STATIC_REQUIRE_FALSE(phi::is_any_of_rv_v<TypeT, ArgsT...>);
#endif
