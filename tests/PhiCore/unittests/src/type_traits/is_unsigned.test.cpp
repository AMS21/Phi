...
TEST_CASE("is_unsigned")
{
    ...
    test_is_not_unsigned<enum_type>();
    test_is_not_unsigned<enum_signed>();
    test_is_not_unsigned<enum_unsigned>();
    test_is_not_unsigned<enum_class>();
    test_is_not_unsigned<enum_struct>();
    ...
    test_is_not_unsigned<IncompleteVariadicTemplate<class_type>>();
    test_is_not_unsigned<IncompleteVariadicTemplate<incomplete_type>>();
    test_is_not_unsigned<IncompleteVariadicTemplate<int, void, class_type, volatile char[]>>();
