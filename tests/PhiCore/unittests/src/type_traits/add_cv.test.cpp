...
TEST_CASE("type_traits.add_cv")
{
    ...
    test_add_cv<ExplicitTo<class_type>>();
    ...
    test_add_cv<public_static_tempalte_member<int>>();
    test_add_cv<public_static_tempalte_member<float>>();
    test_add_cv<public_static_tempalte_member<class_type>>();
    ...
    test_add_cv<enum_type>();
    test_add_cv<enum_signed>();
    test_add_cv<enum_unsigned>();
    test_add_cv<enum_class>();
    test_add_cv<enum_struct>();
    ...
    test_add_cv<IncompleteVariadicTemplate<class_type>>();
    test_add_cv<IncompleteVariadicTemplate<incomplete_type>>();
    test_add_cv<IncompleteVariadicTemplate<int, void, class_type, volatile char[]>>();
    test_add_cv<incomplete_union>();
    test_add_cv<incomplete_enum_signed>();
    test_add_cv<incomplete_enum_unsigned>();
    test_add_cv<incomplete_enum_class>();
    test_add_cv<incomplete_enum_struct>();
    test_add_cv<int class_type::*>();
    test_add_cv<float class_type::*>();
    test_add_cv<void * class_type::*>();
    test_add_cv<int * class_type::*>();
    test_add_cv<enum_type class_type::*>();
