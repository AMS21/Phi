...
TEST_CASE("is_unsafe_fundamental")
{
    ...
    test_is_not_unsafe_fundamental<ExplicitTo<class_type>>();
    ...
    test_is_not_unsafe_fundamental<enum_type>();
    test_is_not_unsafe_fundamental<enum_signed>();
    test_is_not_unsafe_fundamental<enum_unsigned>();
    test_is_not_unsafe_fundamental<enum_class>();
    test_is_not_unsafe_fundamental<enum_struct>();
    ...
    test_is_not_unsafe_fundamental<IncompleteVariadicTemplate<class_type>>();
    test_is_not_unsafe_fundamental<IncompleteVariadicTemplate<incomplete_type>>();
    ...
    test_is_not_unsafe_fundamental<incomplete_enum_signed>();
    test_is_not_unsafe_fundamental<incomplete_enum_unsigned>();
    test_is_not_unsafe_fundamental<incomplete_enum_class>();
    test_is_not_unsafe_fundamental<incomplete_enum_struct>();
