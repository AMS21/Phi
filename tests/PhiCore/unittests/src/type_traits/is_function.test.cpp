...
TEST_CASE("is_function")
{
    ...
    test_is_not_function<final_type>();
    test_is_not_function<enum_type>();
    test_is_not_function<enum_signed>();
    test_is_not_function<enum_unsigned>();
    test_is_not_function<enum_class>();
    test_is_not_function<enum_struct>();
    ...
    test_is_not_function<IncompleteVariadicTemplate<class_type>>();
    test_is_not_function<IncompleteVariadicTemplate<incomplete_type>>();
    test_is_not_function<IncompleteVariadicTemplate<int, void, class_type, volatile char[]>>();
