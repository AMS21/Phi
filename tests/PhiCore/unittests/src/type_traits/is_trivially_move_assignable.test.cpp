...
TEST_CASE("is_trivially_move_assignable")
{
    ...
    test_is_trivially_move_assignable_v<enum_type>();
    test_is_trivially_move_assignable_v<enum_signed>();
    test_is_trivially_move_assignable_v<enum_unsigned>();
    test_is_trivially_move_assignable_v<enum_class>();
    test_is_trivially_move_assignable_v<enum_struct>();
