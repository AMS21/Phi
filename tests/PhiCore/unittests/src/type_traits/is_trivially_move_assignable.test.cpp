...
TEST_CASE("is_trivially_move_assignable")
{
    ...
    test_is_trivially_move_assignable<Template<incomplete_type>>();
    ...
    test_is_trivially_move_assignable<VariadicTemplate<incomplete_type>>();
    test_is_trivially_move_assignable<VariadicTemplate<int, void, Class, volatile char[]>>();
    test_is_trivially_move_assignable<PublicDerviedFromTemplate<Base>>();
    test_is_trivially_move_assignable<PublicDerviedFromTemplate<Derived>>();
    test_is_trivially_move_assignable<PublicDerviedFromTemplate<Class>>();
    test_is_trivially_move_assignable<PrivateDerviedFromTemplate<Base>>();
    test_is_trivially_move_assignable<PrivateDerviedFromTemplate<Derived>>();
    test_is_trivially_move_assignable<PrivateDerviedFromTemplate<Class>>();
    test_is_trivially_move_assignable<ProtectedDerviedFromTemplate<Base>>();
    test_is_trivially_move_assignable<ProtectedDerviedFromTemplate<Derived>>();
    test_is_trivially_move_assignable<ProtectedDerviedFromTemplate<Class>>();
    ...
    test_is_not_trivially_move_assignable<AbstractTemplate<incomplete_type>>();
