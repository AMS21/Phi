...
TEST_CASE("is_safe_bool")
{
    ...
    test_is_not_safe_bool<enum_type>();
    test_is_not_safe_bool<enum_signed>();
    test_is_not_safe_bool<enum_unsigned>();
    test_is_not_safe_bool<enum_class>();
    test_is_not_safe_bool<enum_struct>();
    ...
    test_is_not_safe_bool<IncompleteVariadicTemplate<class_type>>();
    test_is_not_safe_bool<IncompleteVariadicTemplate<incomplete_type>>();
    test_is_not_safe_bool<IncompleteVariadicTemplate<int, void, class_type, volatile char[]>>();
