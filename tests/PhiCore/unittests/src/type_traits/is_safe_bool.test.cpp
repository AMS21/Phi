...
TEST_CASE("is_safe_bool")
{
    ...
    test_is_not_safe_bool<Template<incomplete_type>>();
    ...
    test_is_not_safe_bool<VariadicTemplate<incomplete_type>>();
    test_is_not_safe_bool<VariadicTemplate<int, void, Class, volatile char[]>>();
    test_is_not_safe_bool<PublicDerviedFromTemplate<Base>>();
    test_is_not_safe_bool<PublicDerviedFromTemplate<Derived>>();
    test_is_not_safe_bool<PublicDerviedFromTemplate<Class>>();
    test_is_not_safe_bool<PrivateDerviedFromTemplate<Base>>();
    test_is_not_safe_bool<PrivateDerviedFromTemplate<Derived>>();
    test_is_not_safe_bool<PrivateDerviedFromTemplate<Class>>();
    test_is_not_safe_bool<ProtectedDerviedFromTemplate<Base>>();
    test_is_not_safe_bool<ProtectedDerviedFromTemplate<Derived>>();
    test_is_not_safe_bool<ProtectedDerviedFromTemplate<Class>>();
    ...
    test_is_not_safe_bool<IncompleteTemplate<incomplete_type>>();
    ...
    test_is_not_safe_bool<IncompleteVariadicTemplate<incomplete_type>>();
