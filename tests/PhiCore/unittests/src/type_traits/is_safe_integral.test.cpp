...
{
    STATIC_REQUIRE(phi::is_safe_integral<TypeT>::value);
    STATIC_REQUIRE_FALSE(phi::is_not_safe_integral<TypeT>::value);

#if PHI_HAS_FEATURE_VARIABLE_TEMPLATE()
    STATIC_REQUIRE(phi::is_safe_integral_v<TypeT>);
    STATIC_REQUIRE_FALSE(phi::is_not_safe_integral_v<TypeT>);
#endif

    TEST_TYPE_TRAITS_TYPE_DEFS(phi::is_safe_integral<TypeT>);
    TEST_TYPE_TRAITS_TYPE_DEFS(phi::is_not_safe_integral<TypeT>);
}

template <typename TypeT>
void test_is_not_safe_integral_impl()
{
    STATIC_REQUIRE_FALSE(phi::is_safe_integral<TypeT>::value);
    STATIC_REQUIRE(phi::is_not_safe_integral<TypeT>::value);

#if PHI_HAS_FEATURE_VARIABLE_TEMPLATE()
    STATIC_REQUIRE_FALSE(phi::is_safe_integral_v<TypeT>);
    STATIC_REQUIRE(phi::is_not_safe_integral_v<TypeT>);
#endif
...
{
    test_is_safe_integral_impl<TypeT>();
    test_is_safe_integral_impl<const TypeT>();
    test_is_safe_integral_impl<volatile TypeT>();
    test_is_safe_integral_impl<const volatile TypeT>();
}

template <typename TypeT>
void test_is_not_safe_integral()
{
    test_is_not_safe_integral_impl<TypeT>();
    test_is_not_safe_integral_impl<const TypeT>();
    test_is_not_safe_integral_impl<volatile TypeT>();
    test_is_not_safe_integral_impl<const volatile TypeT>();
}
