...
TEST_CASE("remove_const")
{
    ...
    test_remove_const<enum_type>();
    test_remove_const<enum_signed>();
    test_remove_const<enum_unsigned>();
    test_remove_const<enum_class>();
    test_remove_const<enum_struct>();
    ...
    test_remove_const<IncompleteVariadicTemplate<class_type>>();
    test_remove_const<IncompleteVariadicTemplate<incomplete_type>>();
    test_remove_const<IncompleteVariadicTemplate<int, void, class_type, volatile char[]>>();
