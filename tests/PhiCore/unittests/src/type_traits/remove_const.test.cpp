...
TEST_CASE("remove_const")
{
    ...
    test_remove_const<Template<IncompleteType>>();
    ...
    test_remove_const<VariadicTemplate<IncompleteType>>();
    test_remove_const<VariadicTemplate<int, void, Class, volatile char[]>>();
    test_remove_const<PublicDerivedFromTemplate<Base>>();
    test_remove_const<PublicDerivedFromTemplate<Derived>>();
    test_remove_const<PublicDerivedFromTemplate<Class>>();
    test_remove_const<PrivateDerivedFromTemplate<Base>>();
    test_remove_const<PrivateDerivedFromTemplate<Derived>>();
    test_remove_const<PrivateDerivedFromTemplate<Class>>();
    test_remove_const<ProtectedDerivedFromTemplate<Base>>();
    test_remove_const<ProtectedDerivedFromTemplate<Derived>>();
    test_remove_const<ProtectedDerivedFromTemplate<Class>>();
    test_remove_const<Union>();
    test_remove_const<NonEmptyUnion>();
    test_remove_const<Empty>();
    test_remove_const<NotEmpty>();
    test_remove_const<BitZero>();
    test_remove_const<BitOne>();
    ...
    test_remove_const<AbstractTemplate<IncompleteType>>();
    ...
    test_remove_const<IncompleteType>();
    ...
    test_remove_const<IncompleteTemplate<IncompleteType>>();
    ...
    test_remove_const<IncompleteVariadicTemplate<IncompleteType>>();
