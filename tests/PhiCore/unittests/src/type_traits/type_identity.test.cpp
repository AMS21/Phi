...
TEST_CASE("type_identity")
{
    ...
    test_type_identity<Template<IncompleteType>>();
    ...
    test_type_identity<VariadicTemplate<IncompleteType>>();
    test_type_identity<VariadicTemplate<int, void, Class, volatile char[]>>();
    test_type_identity<PublicDerivedFromTemplate<Base>>();
    test_type_identity<PublicDerivedFromTemplate<Derived>>();
    test_type_identity<PublicDerivedFromTemplate<Class>>();
    test_type_identity<PrivateDerivedFromTemplate<Base>>();
    test_type_identity<PrivateDerivedFromTemplate<Derived>>();
    test_type_identity<PrivateDerivedFromTemplate<Class>>();
    test_type_identity<ProtectedDerivedFromTemplate<Base>>();
    test_type_identity<ProtectedDerivedFromTemplate<Derived>>();
    test_type_identity<ProtectedDerivedFromTemplate<Class>>();
    test_type_identity<Union>();
    test_type_identity<NonEmptyUnion>();
    test_type_identity<Empty>();
    test_type_identity<NotEmpty>();
    test_type_identity<BitZero>();
    test_type_identity<BitOne>();
    ...
    test_type_identity<AbstractTemplate<IncompleteType>>();
    ...
    test_type_identity<IncompleteType>();
    ...
    test_type_identity<IncompleteTemplate<IncompleteType>>();
    ...
    test_type_identity<IncompleteVariadicTemplate<IncompleteType>>();
