...
TEST_CASE("type_identity")
{
    ...
    test_type_identity<enum_type>();
    test_type_identity<enum_signed>();
    test_type_identity<enum_unsigned>();
    test_type_identity<enum_class>();
    test_type_identity<enum_struct>();
    ...
    test_type_identity<IncompleteVariadicTemplate<class_type>>();
    test_type_identity<IncompleteVariadicTemplate<incomplete_type>>();
    test_type_identity<IncompleteVariadicTemplate<int, void, class_type, volatile char[]>>();
