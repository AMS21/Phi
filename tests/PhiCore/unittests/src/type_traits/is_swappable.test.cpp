...
TEST_CASE("is_swappable")
{
    ...
    test_is_swappable<PublicDerviedFromTemplate<Base>>();
    test_is_swappable<PublicDerviedFromTemplate<Derived>>();
    test_is_swappable<PublicDerviedFromTemplate<Class>>();
    test_is_swappable<PrivateDerviedFromTemplate<Base>>();
    test_is_swappable<PrivateDerviedFromTemplate<Derived>>();
    test_is_swappable<PrivateDerviedFromTemplate<Class>>();
    test_is_swappable<ProtectedDerviedFromTemplate<Base>>();
    test_is_swappable<ProtectedDerviedFromTemplate<Derived>>();
    test_is_swappable<ProtectedDerviedFromTemplate<Class>>();
