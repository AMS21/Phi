...
TEST_CASE("is_unsafe_arithmetic")
{
    ...
    test_is_not_unsafe_arithmetic<Template<incomplete_type>>();
    ...
    test_is_not_unsafe_arithmetic<VariadicTemplate<incomplete_type>>();
    test_is_not_unsafe_arithmetic<VariadicTemplate<int, void, Class, volatile char[]>>();
    test_is_not_unsafe_arithmetic<PublicDerviedFromTemplate<Base>>();
    test_is_not_unsafe_arithmetic<PublicDerviedFromTemplate<Derived>>();
    test_is_not_unsafe_arithmetic<PublicDerviedFromTemplate<Class>>();
    test_is_not_unsafe_arithmetic<PrivateDerviedFromTemplate<Base>>();
    test_is_not_unsafe_arithmetic<PrivateDerviedFromTemplate<Derived>>();
    test_is_not_unsafe_arithmetic<PrivateDerviedFromTemplate<Class>>();
    test_is_not_unsafe_arithmetic<ProtectedDerviedFromTemplate<Base>>();
    test_is_not_unsafe_arithmetic<ProtectedDerviedFromTemplate<Derived>>();
    test_is_not_unsafe_arithmetic<ProtectedDerviedFromTemplate<Class>>();
    ...
    test_is_not_unsafe_arithmetic<IncompleteTemplate<incomplete_type>>();
    ...
    test_is_not_unsafe_arithmetic<IncompleteVariadicTemplate<incomplete_type>>();
