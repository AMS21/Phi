...
void test_is_signed_integer_impl()
{
    ...
    TEST_TYPE_TRAITS_TYPE_DEFS(phi::is_signed_integer<T>);
    TEST_TYPE_TRAITS_TYPE_DEFS(phi::is_not_signed_integer<T>);
}
...
TEST_CASE("is_signed_integer")
{
    ...
    test_is_not_signed_integer<ExplicitTo<class_type>>();
    ...
    test_is_not_signed_integer<enum_type>();
    test_is_not_signed_integer<enum_signed>();
    test_is_not_signed_integer<enum_unsigned>();
    test_is_not_signed_integer<enum_class>();
    test_is_not_signed_integer<enum_struct>();
    ...
    test_is_not_signed_integer<IncompleteVariadicTemplate<class_type>>();
    test_is_not_signed_integer<IncompleteVariadicTemplate<incomplete_type>>();
    ...
    test_is_not_signed_integer<incomplete_enum_signed>();
    test_is_not_signed_integer<incomplete_enum_unsigned>();
    test_is_not_signed_integer<incomplete_enum_class>();
    test_is_not_signed_integer<incomplete_enum_struct>();
