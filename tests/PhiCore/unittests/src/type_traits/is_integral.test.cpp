...
TEST_CASE("is_integral")
{
    ...
    test_is_not_integral<final_type>();
    test_is_not_integral<enum_type>();
    test_is_not_integral<enum_signed>();
    test_is_not_integral<enum_unsigned>();
    test_is_not_integral<enum_class>();
    test_is_not_integral<enum_struct>();
    ...
    test_is_not_integral<IncompleteVariadicTemplate<class_type>>();
    test_is_not_integral<IncompleteVariadicTemplate<incomplete_type>>();
    test_is_not_integral<IncompleteVariadicTemplate<int, void, class_type, volatile char[]>>();
