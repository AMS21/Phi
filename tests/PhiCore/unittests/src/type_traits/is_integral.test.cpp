...
TEST_CASE("is_integral")
{
    ...
    test_is_not_integral<Template<IncompleteType>>();
    ...
    test_is_not_integral<VariadicTemplate<IncompleteType>>();
    test_is_not_integral<VariadicTemplate<int, void, Class, volatile char[]>>();
    test_is_not_integral<PublicDerivedFromTemplate<Base>>();
    test_is_not_integral<PublicDerivedFromTemplate<Derived>>();
    test_is_not_integral<PublicDerivedFromTemplate<Class>>();
    test_is_not_integral<PrivateDerivedFromTemplate<Base>>();
    test_is_not_integral<PrivateDerivedFromTemplate<Derived>>();
    test_is_not_integral<PrivateDerivedFromTemplate<Class>>();
    test_is_not_integral<ProtectedDerivedFromTemplate<Base>>();
    test_is_not_integral<ProtectedDerivedFromTemplate<Derived>>();
    test_is_not_integral<ProtectedDerivedFromTemplate<Class>>();
    test_is_not_integral<Union>();
    test_is_not_integral<NonEmptyUnion>();
    test_is_not_integral<Empty>();
    test_is_not_integral<NotEmpty>();
    test_is_not_integral<BitZero>();
    test_is_not_integral<BitOne>();
    ...
    test_is_not_integral<AbstractTemplate<IncompleteType>>();
    ...
    test_is_not_integral<IncompleteType>();
    ...
    test_is_not_integral<IncompleteTemplate<IncompleteType>>();
    ...
    test_is_not_integral<IncompleteVariadicTemplate<IncompleteType>>();
