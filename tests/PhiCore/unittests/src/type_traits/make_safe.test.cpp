...
TEST_CASE("make_safe")
{
    ...
    test_make_safe<Template<incomplete_type>>();
    ...
    test_make_safe<VariadicTemplate<incomplete_type>>();
    test_make_safe<VariadicTemplate<int, void, Class, volatile char[]>>();
    test_make_safe<PublicDerviedFromTemplate<Base>>();
    test_make_safe<PublicDerviedFromTemplate<Derived>>();
    test_make_safe<PublicDerviedFromTemplate<Class>>();
    test_make_safe<PrivateDerviedFromTemplate<Base>>();
    test_make_safe<PrivateDerviedFromTemplate<Derived>>();
    test_make_safe<PrivateDerviedFromTemplate<Class>>();
    test_make_safe<ProtectedDerviedFromTemplate<Base>>();
    test_make_safe<ProtectedDerviedFromTemplate<Derived>>();
    test_make_safe<ProtectedDerviedFromTemplate<Class>>();
    ...
    test_make_safe<AbstractTemplate<incomplete_type>>();
    ...
    test_make_safe<IncompleteTemplate<incomplete_type>>();
    ...
    test_make_safe<IncompleteVariadicTemplate<incomplete_type>>();
