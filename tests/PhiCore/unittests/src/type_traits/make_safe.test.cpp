...
TEST_CASE("make_safe")
{
    ...
    test_make_safe<enum_type>();
    test_make_safe<enum_signed>();
    test_make_safe<enum_unsigned>();
    test_make_safe<enum_class>();
    test_make_safe<enum_struct>();
    ...
    test_make_safe<IncompleteVariadicTemplate<class_type>>();
    test_make_safe<IncompleteVariadicTemplate<incomplete_type>>();
    test_make_safe<IncompleteVariadicTemplate<int, void, class_type, volatile char[]>>();
