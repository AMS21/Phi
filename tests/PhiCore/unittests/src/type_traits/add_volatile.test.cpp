...
TEST_CASE("add_volatile")
{
    ...
    test_add_volatile<Template<IncompleteType>>();
    ...
    test_add_volatile<VariadicTemplate<IncompleteType>>();
    test_add_volatile<VariadicTemplate<int, void, Class, volatile char[]>>();
    test_add_volatile<PublicDerivedFromTemplate<Base>>();
    test_add_volatile<PublicDerivedFromTemplate<Derived>>();
    test_add_volatile<PublicDerivedFromTemplate<Class>>();
    test_add_volatile<PrivateDerivedFromTemplate<Base>>();
    test_add_volatile<PrivateDerivedFromTemplate<Derived>>();
    test_add_volatile<PrivateDerivedFromTemplate<Class>>();
    test_add_volatile<ProtectedDerivedFromTemplate<Base>>();
    test_add_volatile<ProtectedDerivedFromTemplate<Derived>>();
    test_add_volatile<ProtectedDerivedFromTemplate<Class>>();
    test_add_volatile<Union>();
    test_add_volatile<NonEmptyUnion>();
    test_add_volatile<Empty>();
    test_add_volatile<NotEmpty>();
    test_add_volatile<BitZero>();
    test_add_volatile<BitOne>();
    ...
    test_add_volatile<AbstractTemplate<IncompleteType>>();
    ...
    test_add_volatile<IncompleteType>();
    ...
    test_add_volatile<IncompleteTemplate<IncompleteType>>();
    ...
    test_add_volatile<IncompleteVariadicTemplate<IncompleteType>>();
