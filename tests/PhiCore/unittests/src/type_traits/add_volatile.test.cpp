...
TEST_CASE("add_volatile")
{
    ...
    test_add_volatile<enum_type>();
    test_add_volatile<enum_signed>();
    test_add_volatile<enum_unsigned>();
    test_add_volatile<enum_class>();
    test_add_volatile<enum_struct>();
    ...
    test_add_volatile<IncompleteVariadicTemplate<class_type>>();
    test_add_volatile<IncompleteVariadicTemplate<incomplete_type>>();
    test_add_volatile<IncompleteVariadicTemplate<int, void, class_type, volatile char[]>>();
