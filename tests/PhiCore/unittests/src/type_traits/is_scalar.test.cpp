...
TEST_CASE("is_scalar")
{
    ...
    test_is_scalar<enum_type>();
    test_is_scalar<enum_signed>();
    test_is_scalar<enum_unsigned>();
    test_is_scalar<enum_class>();
    test_is_scalar<enum_struct>();
    ...
    test_is_not_scalar<IncompleteVariadicTemplate<class_type>>();
    test_is_not_scalar<IncompleteVariadicTemplate<incomplete_type>>();
    test_is_not_scalar<IncompleteVariadicTemplate<int, void, class_type, volatile char[]>>();
