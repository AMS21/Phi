...
TEST_CASE("is_scalar")
{
    ...
    test_is_not_scalar<Template<incomplete_type>>();
    ...
    test_is_not_scalar<VariadicTemplate<incomplete_type>>();
    test_is_not_scalar<VariadicTemplate<int, void, Class, volatile char[]>>();
    test_is_not_scalar<PublicDerviedFromTemplate<Base>>();
    test_is_not_scalar<PublicDerviedFromTemplate<Derived>>();
    test_is_not_scalar<PublicDerviedFromTemplate<Class>>();
    test_is_not_scalar<PrivateDerviedFromTemplate<Base>>();
    test_is_not_scalar<PrivateDerviedFromTemplate<Derived>>();
    test_is_not_scalar<PrivateDerviedFromTemplate<Class>>();
    test_is_not_scalar<ProtectedDerviedFromTemplate<Base>>();
    test_is_not_scalar<ProtectedDerviedFromTemplate<Derived>>();
    test_is_not_scalar<ProtectedDerviedFromTemplate<Class>>();
    ...
    test_is_not_scalar<IncompleteTemplate<incomplete_type>>();
    ...
    test_is_not_scalar<IncompleteVariadicTemplate<incomplete_type>>();
