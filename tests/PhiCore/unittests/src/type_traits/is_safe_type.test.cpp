...
TEST_CASE("is_safe_type")
{
    ...
    test_is_not_safe_type<enum_type>();
    test_is_not_safe_type<enum_signed>();
    test_is_not_safe_type<enum_unsigned>();
    test_is_not_safe_type<enum_class>();
    test_is_not_safe_type<enum_struct>();
    ...
    test_is_not_safe_type<IncompleteVariadicTemplate<class_type>>();
    test_is_not_safe_type<IncompleteVariadicTemplate<incomplete_type>>();
    test_is_not_safe_type<IncompleteVariadicTemplate<int, void, class_type, volatile char[]>>();
