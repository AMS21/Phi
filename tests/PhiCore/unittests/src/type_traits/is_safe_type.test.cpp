...
void test_is_safe_type_impl()
{
    ...
    TEST_TYPE_TRAITS_TYPE_DEFS(phi::is_safe_type<T>);
    TEST_TYPE_TRAITS_TYPE_DEFS(phi::is_not_safe_type<T>);
}
...
TEST_CASE("is_safe_type")
{
    ...
    test_is_not_safe_type<Template<IncompleteType>>();
    ...
    test_is_not_safe_type<VariadicTemplate<IncompleteType>>();
    test_is_not_safe_type<VariadicTemplate<int, void, Class, volatile char[]>>();
    test_is_not_safe_type<PublicDerivedFromTemplate<Base>>();
    test_is_not_safe_type<PublicDerivedFromTemplate<Derived>>();
    test_is_not_safe_type<PublicDerivedFromTemplate<Class>>();
    test_is_not_safe_type<PrivateDerivedFromTemplate<Base>>();
    test_is_not_safe_type<PrivateDerivedFromTemplate<Derived>>();
    test_is_not_safe_type<PrivateDerivedFromTemplate<Class>>();
    test_is_not_safe_type<ProtectedDerivedFromTemplate<Base>>();
    test_is_not_safe_type<ProtectedDerivedFromTemplate<Derived>>();
    test_is_not_safe_type<ProtectedDerivedFromTemplate<Class>>();
    test_is_not_safe_type<Union>();
    test_is_not_safe_type<NonEmptyUnion>();
    test_is_not_safe_type<Empty>();
    test_is_not_safe_type<NotEmpty>();
    test_is_not_safe_type<BitZero>();
    test_is_not_safe_type<BitOne>();
    ...
    test_is_not_safe_type<AbstractTemplate<IncompleteType>>();
    ...
    test_is_not_safe_type<IncompleteType>();
    ...
    test_is_not_safe_type<IncompleteTemplate<IncompleteType>>();
    ...
    test_is_not_safe_type<IncompleteVariadicTemplate<IncompleteType>>();
