...
TEST_CASE("is_unscoped_enum")
{
    ...
    test_is_not_unscoped_enum<Template<incomplete_type>>();
    ...
    test_is_not_unscoped_enum<VariadicTemplate<incomplete_type>>();
    test_is_not_unscoped_enum<VariadicTemplate<int, void, Class, volatile char[]>>();
    test_is_not_unscoped_enum<PublicDerviedFromTemplate<Base>>();
    test_is_not_unscoped_enum<PublicDerviedFromTemplate<Derived>>();
    test_is_not_unscoped_enum<PublicDerviedFromTemplate<Class>>();
    test_is_not_unscoped_enum<PrivateDerviedFromTemplate<Base>>();
    test_is_not_unscoped_enum<PrivateDerviedFromTemplate<Derived>>();
    test_is_not_unscoped_enum<PrivateDerviedFromTemplate<Class>>();
    test_is_not_unscoped_enum<ProtectedDerviedFromTemplate<Base>>();
    test_is_not_unscoped_enum<ProtectedDerviedFromTemplate<Derived>>();
    test_is_not_unscoped_enum<ProtectedDerviedFromTemplate<Class>>();
    ...
    test_is_not_unscoped_enum<IncompleteTemplate<incomplete_type>>();
