...
TEST_CASE("is_lvalue_reference")
{
    ...
    test_is_not_lvalue_reference<Template<incomplete_type>>();
    ...
    test_is_not_lvalue_reference<VariadicTemplate<incomplete_type>>();
    test_is_not_lvalue_reference<VariadicTemplate<int, void, Class, volatile char[]>>();
    test_is_not_lvalue_reference<PublicDerviedFromTemplate<Base>>();
    test_is_not_lvalue_reference<PublicDerviedFromTemplate<Derived>>();
    test_is_not_lvalue_reference<PublicDerviedFromTemplate<Class>>();
    test_is_not_lvalue_reference<PrivateDerviedFromTemplate<Base>>();
    test_is_not_lvalue_reference<PrivateDerviedFromTemplate<Derived>>();
    test_is_not_lvalue_reference<PrivateDerviedFromTemplate<Class>>();
    test_is_not_lvalue_reference<ProtectedDerviedFromTemplate<Base>>();
    test_is_not_lvalue_reference<ProtectedDerviedFromTemplate<Derived>>();
    test_is_not_lvalue_reference<ProtectedDerviedFromTemplate<Class>>();
    ...
    test_is_not_lvalue_reference<AbstractTemplate<incomplete_type>>();
    ...
    test_is_not_lvalue_reference<IncompleteTemplate<incomplete_type>>();
    ...
    test_is_not_lvalue_reference<IncompleteVariadicTemplate<incomplete_type>>();
