...
void test_is_fundamental_impl()
{
    ...
    TEST_TYPE_TRAITS_TYPE_DEFS(phi::is_fundamental<T>);
    TEST_TYPE_TRAITS_TYPE_DEFS(phi::is_not_fundamental<T>);
}
...
TEST_CASE("is_fundamental")
{
    ...
    test_is_not_fundamental<enum_type>();
    test_is_not_fundamental<enum_signed>();
    test_is_not_fundamental<enum_unsigned>();
    test_is_not_fundamental<enum_class>();
    test_is_not_fundamental<enum_struct>();
    ...
    test_is_not_fundamental<IncompleteVariadicTemplate<class_type>>();
    test_is_not_fundamental<IncompleteVariadicTemplate<incomplete_type>>();
    test_is_not_fundamental<IncompleteVariadicTemplate<int, void, class_type, volatile char[]>>();
