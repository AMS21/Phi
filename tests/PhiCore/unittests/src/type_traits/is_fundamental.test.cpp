...
TEST_CASE("is_fundamental")
{
    ...
    test_is_not_fundamental<Template<incomplete_type>>();
    ...
    test_is_not_fundamental<VariadicTemplate<incomplete_type>>();
    test_is_not_fundamental<VariadicTemplate<int, void, Class, volatile char[]>>();
    test_is_not_fundamental<PublicDerviedFromTemplate<Base>>();
    test_is_not_fundamental<PublicDerviedFromTemplate<Derived>>();
    test_is_not_fundamental<PublicDerviedFromTemplate<Class>>();
    test_is_not_fundamental<PrivateDerviedFromTemplate<Base>>();
    test_is_not_fundamental<PrivateDerviedFromTemplate<Derived>>();
    test_is_not_fundamental<PrivateDerviedFromTemplate<Class>>();
    test_is_not_fundamental<ProtectedDerviedFromTemplate<Base>>();
    test_is_not_fundamental<ProtectedDerviedFromTemplate<Derived>>();
    test_is_not_fundamental<ProtectedDerviedFromTemplate<Class>>();
    ...
    test_is_not_fundamental<AbstractTemplate<incomplete_type>>();
    ...
    test_is_not_fundamental<IncompleteTemplate<incomplete_type>>();
    ...
    test_is_not_fundamental<IncompleteVariadicTemplate<incomplete_type>>();
