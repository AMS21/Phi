...
TEST_CASE("is_polymorphic")
{
    ...
    test_is_not_polymorphic<Template<incomplete_type>>();
    ...
    test_is_not_polymorphic<VariadicTemplate<incomplete_type>>();
    test_is_not_polymorphic<VariadicTemplate<int, void, Class, volatile char[]>>();
    test_is_not_polymorphic<PublicDerviedFromTemplate<Base>>();
    test_is_not_polymorphic<PublicDerviedFromTemplate<Derived>>();
    test_is_not_polymorphic<PublicDerviedFromTemplate<Class>>();
    test_is_not_polymorphic<PrivateDerviedFromTemplate<Base>>();
    test_is_not_polymorphic<PrivateDerviedFromTemplate<Derived>>();
    test_is_not_polymorphic<PrivateDerviedFromTemplate<Class>>();
    test_is_not_polymorphic<ProtectedDerviedFromTemplate<Base>>();
    test_is_not_polymorphic<ProtectedDerviedFromTemplate<Derived>>();
    test_is_not_polymorphic<ProtectedDerviedFromTemplate<Class>>();
    ...
    test_is_polymorphic<AbstractTemplate<incomplete_type>>();
