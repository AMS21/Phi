...
TEST_CASE("is_nothrow_move_constructible")
{
    ...
    test_is_nothrow_move_constructible_c<Template<incomplete_type>>();
    ...
    test_is_nothrow_move_constructible_c<VariadicTemplate<incomplete_type>>();
    test_is_nothrow_move_constructible_c<VariadicTemplate<int, void, Class, volatile char[]>>();
    test_is_nothrow_move_constructible_c<PublicDerviedFromTemplate<Base>>();
    test_is_nothrow_move_constructible_c<PublicDerviedFromTemplate<Derived>>();
    test_is_nothrow_move_constructible_c<PublicDerviedFromTemplate<Class>>();
    test_is_nothrow_move_constructible_c<PrivateDerviedFromTemplate<Base>>();
    test_is_nothrow_move_constructible_c<PrivateDerviedFromTemplate<Derived>>();
    test_is_nothrow_move_constructible_c<PrivateDerviedFromTemplate<Class>>();
    test_is_nothrow_move_constructible_c<ProtectedDerviedFromTemplate<Base>>();
    test_is_nothrow_move_constructible_c<ProtectedDerviedFromTemplate<Derived>>();
    test_is_nothrow_move_constructible_c<ProtectedDerviedFromTemplate<Class>>();
    ...
    test_is_not_nothrow_move_constructible<AbstractTemplate<incomplete_type>>();
#endif
