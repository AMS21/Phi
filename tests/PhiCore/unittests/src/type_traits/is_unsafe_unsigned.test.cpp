...
TEST_CASE("is_unsafe_unsigned")
{
    ...
    test_is_not_unsafe_unsigned<ExplicitTo<class_type>>();
    ...
    test_is_not_unsafe_unsigned<public_static_tempalte_member<int>>();
    test_is_not_unsafe_unsigned<public_static_tempalte_member<float>>();
    test_is_not_unsafe_unsigned<public_static_tempalte_member<class_type>>();
    ...
    test_is_not_unsafe_unsigned<enum_type>();
    test_is_not_unsafe_unsigned<enum_signed>();
    test_is_not_unsafe_unsigned<enum_unsigned>();
    test_is_not_unsafe_unsigned<enum_class>();
    test_is_not_unsafe_unsigned<enum_struct>();
    ...
    test_is_not_unsafe_unsigned<IncompleteVariadicTemplate<class_type>>();
    test_is_not_unsafe_unsigned<IncompleteVariadicTemplate<incomplete_type>>();
    ...
    test_is_not_unsafe_unsigned<incomplete_enum_signed>();
    test_is_not_unsafe_unsigned<incomplete_enum_unsigned>();
    test_is_not_unsafe_unsigned<incomplete_enum_class>();
    test_is_not_unsafe_unsigned<incomplete_enum_struct>();
