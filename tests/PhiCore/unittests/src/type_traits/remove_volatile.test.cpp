...
TEST_CASE("remove_volatile")
{
    ...
    test_remove_volatile<Template<incomplete_type>>();
    ...
    test_remove_volatile<VariadicTemplate<incomplete_type>>();
    test_remove_volatile<VariadicTemplate<int, void, Class, volatile char[]>>();
    test_remove_volatile<PublicDerviedFromTemplate<Base>>();
    test_remove_volatile<PublicDerviedFromTemplate<Derived>>();
    test_remove_volatile<PublicDerviedFromTemplate<Class>>();
    test_remove_volatile<PrivateDerviedFromTemplate<Base>>();
    test_remove_volatile<PrivateDerviedFromTemplate<Derived>>();
    test_remove_volatile<PrivateDerviedFromTemplate<Class>>();
    test_remove_volatile<ProtectedDerviedFromTemplate<Base>>();
    test_remove_volatile<ProtectedDerviedFromTemplate<Derived>>();
    test_remove_volatile<ProtectedDerviedFromTemplate<Class>>();
    ...
    test_remove_volatile<AbstractTemplate<incomplete_type>>();
    ...
    test_remove_volatile<IncompleteTemplate<incomplete_type>>();
    ...
    test_remove_volatile<IncompleteVariadicTemplate<incomplete_type>>();
