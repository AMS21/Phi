...
TEST_CASE("remove_volatile")
{
    ...
    test_remove_volatile<enum_type>();
    test_remove_volatile<enum_signed>();
    test_remove_volatile<enum_unsigned>();
    test_remove_volatile<enum_class>();
    test_remove_volatile<enum_struct>();
    ...
    test_remove_volatile<IncompleteVariadicTemplate<class_type>>();
    test_remove_volatile<IncompleteVariadicTemplate<incomplete_type>>();
    test_remove_volatile<IncompleteVariadicTemplate<int, void, class_type, volatile char[]>>();
