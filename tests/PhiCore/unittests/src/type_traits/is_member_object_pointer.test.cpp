...
#    endif
    ...
    TEST_TYPE_TRAITS_TYPE_DEFS(phi::is_member_object_pointer<T>);
    TEST_TYPE_TRAITS_TYPE_DEFS(phi::is_not_member_object_pointer<T>);
...
TEST_CASE("is_member_object_pointer")
{
    ...
    test_is_not_member_object_pointer<enum_type>();
    test_is_not_member_object_pointer<enum_signed>();
    test_is_not_member_object_pointer<enum_unsigned>();
    test_is_not_member_object_pointer<enum_class>();
    test_is_not_member_object_pointer<enum_struct>();
    ...
    test_is_not_member_object_pointer<IncompleteVariadicTemplate<class_type>>();
