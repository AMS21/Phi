...
TEST_CASE("is_same")
{
    ...
    test_is_same<ExplicitTo<class_type>>();
    ...
    test_is_same<public_static_tempalte_member<int>>();
    test_is_same<public_static_tempalte_member<float>>();
    test_is_same<public_static_tempalte_member<class_type>>();
    ...
    test_is_same<enum_type>();
    test_is_same<enum_signed>();
    test_is_same<enum_unsigned>();
    test_is_same<enum_class>();
    test_is_same<enum_struct>();
    ...
    test_is_same<IncompleteVariadicTemplate<class_type>>();
    test_is_same<IncompleteVariadicTemplate<incomplete_type>>();
    test_is_same<IncompleteVariadicTemplate<int, void, class_type, volatile char[]>>();
    test_is_same<incomplete_union>();
    test_is_same<incomplete_enum_signed>();
    test_is_same<incomplete_enum_unsigned>();
    test_is_same<incomplete_enum_class>();
    test_is_same<incomplete_enum_struct>();
    test_is_same<int class_type::*>();
    test_is_same<float class_type::*>();
    test_is_same<void * class_type::*>();
    test_is_same<int * class_type::*>();
    test_is_same<enum_type class_type::*>();
    ...
    test_is_same_ref<int * class_type::*&>();
    test_is_same_ref<enum_type class_type::*&>();
