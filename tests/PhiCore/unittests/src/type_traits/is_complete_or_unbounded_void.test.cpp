...
TEST_CASE("is_complete_or_unbounded_void")
{
    ...
    test_is_complete_or_unbounded_void<Template<IncompleteType>>();
    ...
    test_is_complete_or_unbounded_void<VariadicTemplate<IncompleteType>>();
    test_is_complete_or_unbounded_void<VariadicTemplate<int, void, Class, volatile char[]>>();
    test_is_complete_or_unbounded_void<PublicDerivedFromTemplate<Base>>();
    test_is_complete_or_unbounded_void<PublicDerivedFromTemplate<Derived>>();
    test_is_complete_or_unbounded_void<PublicDerivedFromTemplate<Class>>();
    test_is_complete_or_unbounded_void<PrivateDerivedFromTemplate<Base>>();
    test_is_complete_or_unbounded_void<PrivateDerivedFromTemplate<Derived>>();
    test_is_complete_or_unbounded_void<PrivateDerivedFromTemplate<Class>>();
    test_is_complete_or_unbounded_void<ProtectedDerivedFromTemplate<Base>>();
    test_is_complete_or_unbounded_void<ProtectedDerivedFromTemplate<Derived>>();
    test_is_complete_or_unbounded_void<ProtectedDerivedFromTemplate<Class>>();
    ...
    test_is_complete_or_unbounded_void<BitZero>();
    test_is_complete_or_unbounded_void<BitOne>();
    ...
    test_is_complete_or_unbounded_void<AbstractTemplate<IncompleteType>>();
    ...
    test_is_not_complete_or_unbounded_void<IncompleteType>();
    ...
    test_is_not_complete_or_unbounded_void<IncompleteTemplate<IncompleteType>>();
    ...
    test_is_not_complete_or_unbounded_void<IncompleteVariadicTemplate<IncompleteType>>();
