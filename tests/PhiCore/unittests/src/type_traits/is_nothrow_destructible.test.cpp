...
TEST_CASE("is_nothrow_destructible")
{
    ...
    test_is_nothrow_destructible<Template<IncompleteType>>();
    ...
    test_is_nothrow_destructible<VariadicTemplate<IncompleteType>>();
    test_is_nothrow_destructible<VariadicTemplate<int, void, Class, volatile char[]>>();
    test_is_nothrow_destructible<PublicDerivedFromTemplate<Base>>();
    test_is_nothrow_destructible<PublicDerivedFromTemplate<Derived>>();
    test_is_nothrow_destructible<PublicDerivedFromTemplate<Class>>();
    test_is_nothrow_destructible<PrivateDerivedFromTemplate<Base>>();
    test_is_nothrow_destructible<PrivateDerivedFromTemplate<Derived>>();
    test_is_nothrow_destructible<PrivateDerivedFromTemplate<Class>>();
    test_is_nothrow_destructible<ProtectedDerivedFromTemplate<Base>>();
    test_is_nothrow_destructible<ProtectedDerivedFromTemplate<Derived>>();
    test_is_nothrow_destructible<ProtectedDerivedFromTemplate<Class>>();
    ...
    test_is_nothrow_destructible<BitZero>();
    test_is_nothrow_destructible<BitOne>();
    ...
    test_is_nothrow_destructible<AbstractTemplate<IncompleteType>>();
