...
TEST_CASE("type_traits.add_const")
{
    ...
    test_add_const<ExplicitTo<class_type>>();
    ...
    test_add_const<enum_type>();
    test_add_const<enum_signed>();
    test_add_const<enum_unsigned>();
    test_add_const<enum_class>();
    test_add_const<enum_struct>();
    ...
    test_add_const<IncompleteVariadicTemplate<class_type>>();
    test_add_const<IncompleteVariadicTemplate<incomplete_type>>();
    test_add_const<IncompleteVariadicTemplate<int, void, class_type, volatile char[]>>();
    test_add_const<incomplete_union>();
    test_add_const<incomplete_enum_signed>();
    test_add_const<incomplete_enum_unsigned>();
    test_add_const<incomplete_enum_class>();
    test_add_const<incomplete_enum_struct>();
    test_add_const<int class_type::*>();
    test_add_const<float class_type::*>();
    test_add_const<void * class_type::*>();
    test_add_const<int * class_type::*>();
    test_add_const<enum_type class_type::*>();
