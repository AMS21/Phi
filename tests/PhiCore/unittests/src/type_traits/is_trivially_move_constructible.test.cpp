...
TEST_CASE("is_trivially_move_constructible")
{
    ...
    test_is_trivially_move_constructible_c<Template<incomplete_type>>();
    ...
    test_is_trivially_move_constructible_c<VariadicTemplate<incomplete_type>>();
    test_is_trivially_move_constructible_c<VariadicTemplate<int, void, Class, volatile char[]>>();
    test_is_trivially_move_constructible_c<PublicDerviedFromTemplate<Base>>();
    test_is_trivially_move_constructible_c<PublicDerviedFromTemplate<Derived>>();
    test_is_not_trivially_move_constructible<PublicDerviedFromTemplate<Class>>();
    test_is_trivially_move_constructible_c<PrivateDerviedFromTemplate<Base>>();
    test_is_trivially_move_constructible_c<PrivateDerviedFromTemplate<Derived>>();
    test_is_not_trivially_move_constructible<PrivateDerviedFromTemplate<Class>>();
    test_is_trivially_move_constructible_c<ProtectedDerviedFromTemplate<Base>>();
    test_is_trivially_move_constructible_c<ProtectedDerviedFromTemplate<Derived>>();
    test_is_not_trivially_move_constructible<ProtectedDerviedFromTemplate<Class>>();
    ...
    test_is_not_trivially_move_constructible<AbstractTemplate<incomplete_type>>();
