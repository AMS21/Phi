...
TEST_CASE("add_rvalue_reference")
{
    ...
    test_add_rvalue_reference<Template<IncompleteType>>();
    ...
    test_add_rvalue_reference<VariadicTemplate<IncompleteType>>();
    test_add_rvalue_reference<VariadicTemplate<int, void, Class, volatile char[]>>();
    test_add_rvalue_reference<PublicDerivedFromTemplate<Base>>();
    test_add_rvalue_reference<PublicDerivedFromTemplate<Derived>>();
    test_add_rvalue_reference<PublicDerivedFromTemplate<Class>>();
    test_add_rvalue_reference<PrivateDerivedFromTemplate<Base>>();
    test_add_rvalue_reference<PrivateDerivedFromTemplate<Derived>>();
    test_add_rvalue_reference<PrivateDerivedFromTemplate<Class>>();
    test_add_rvalue_reference<ProtectedDerivedFromTemplate<Base>>();
    test_add_rvalue_reference<ProtectedDerivedFromTemplate<Derived>>();
    test_add_rvalue_reference<ProtectedDerivedFromTemplate<Class>>();
    ...
    test_add_rvalue_reference<BitZero>();
    test_add_rvalue_reference<BitOne>();
    ...
    test_add_rvalue_reference<AbstractTemplate<IncompleteType>>();
    ...
    test_add_rvalue_reference<IncompleteType>();
    ...
    test_add_rvalue_reference<IncompleteTemplate<IncompleteType>>();
    ...
    test_add_rvalue_reference<IncompleteVariadicTemplate<IncompleteType>>();
