...
TEST_CASE("is_final")
{
    ...
    test_is_not_final<Template<incomplete_type>>();
    ...
    test_is_not_final<VariadicTemplate<incomplete_type>>();
    test_is_not_final<VariadicTemplate<int, void, Class, volatile char[]>>();
    test_is_not_final<PublicDerviedFromTemplate<Base>>();
    test_is_not_final<PublicDerviedFromTemplate<Derived>>();
    test_is_not_final<PublicDerviedFromTemplate<Class>>();
    test_is_not_final<PrivateDerviedFromTemplate<Base>>();
    test_is_not_final<PrivateDerviedFromTemplate<Derived>>();
    test_is_not_final<PrivateDerviedFromTemplate<Class>>();
    test_is_not_final<ProtectedDerviedFromTemplate<Base>>();
    test_is_not_final<ProtectedDerviedFromTemplate<Derived>>();
    test_is_not_final<ProtectedDerviedFromTemplate<Class>>();
    ...
    test_is_not_final<AbstractTemplate<incomplete_type>>();
    test_is_final<Final>();
