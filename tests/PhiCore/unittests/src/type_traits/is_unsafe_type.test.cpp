...
TEST_CASE("is_unsafe_type")
{
    ...
    test_is_not_unsafe_type<Template<incomplete_type>>();
    ...
    test_is_not_unsafe_type<VariadicTemplate<incomplete_type>>();
    test_is_not_unsafe_type<VariadicTemplate<int, void, Class, volatile char[]>>();
    test_is_not_unsafe_type<PublicDerviedFromTemplate<Base>>();
    test_is_not_unsafe_type<PublicDerviedFromTemplate<Derived>>();
    test_is_not_unsafe_type<PublicDerviedFromTemplate<Class>>();
    test_is_not_unsafe_type<PrivateDerviedFromTemplate<Base>>();
    test_is_not_unsafe_type<PrivateDerviedFromTemplate<Derived>>();
    test_is_not_unsafe_type<PrivateDerviedFromTemplate<Class>>();
    test_is_not_unsafe_type<ProtectedDerviedFromTemplate<Base>>();
    test_is_not_unsafe_type<ProtectedDerviedFromTemplate<Derived>>();
    test_is_not_unsafe_type<ProtectedDerviedFromTemplate<Class>>();
    ...
    test_is_not_unsafe_type<IncompleteTemplate<incomplete_type>>();
