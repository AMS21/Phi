...
TEST_CASE("rank")
{
    ...
    test_rank<Template<incomplete_type>>();
    test_rank<VariadicTemplate<>>();
    test_rank<VariadicTemplate<void>>();
    test_rank<VariadicTemplate<int>>();
    test_rank<VariadicTemplate<Class>>();
    test_rank<VariadicTemplate<incomplete_type>>();
    test_rank<VariadicTemplate<int, void, Class, volatile char[]>>();
    test_rank<PublicDerviedFromTemplate<Base>>();
    test_rank<PublicDerviedFromTemplate<Derived>>();
    test_rank<PublicDerviedFromTemplate<Class>>();
    test_rank<PrivateDerviedFromTemplate<Base>>();
    test_rank<PrivateDerviedFromTemplate<Derived>>();
    test_rank<PrivateDerviedFromTemplate<Class>>();
    test_rank<ProtectedDerviedFromTemplate<Base>>();
    test_rank<ProtectedDerviedFromTemplate<Derived>>();
    test_rank<ProtectedDerviedFromTemplate<Class>>();
    test_rank<Union>();
    ...
    test_rank<AbstractTemplate<incomplete_type>>();
    test_rank<Final>();
    ...
    test_rank<IncompleteTemplate<incomplete_type>>();
    ...
    test_rank<IncompleteVariadicTemplate<incomplete_type>>();
