...
TEST_CASE("rank")
{
    ...
    test_rank<enum_type>();
    test_rank<enum_signed>();
    test_rank<enum_unsigned>();
    test_rank<enum_class>();
    test_rank<enum_struct>();
    ...
    test_rank<IncompleteVariadicTemplate<class_type>>();
    test_rank<IncompleteVariadicTemplate<incomplete_type>>();
    test_rank<IncompleteVariadicTemplate<int, void, class_type, volatile char[]>>();
