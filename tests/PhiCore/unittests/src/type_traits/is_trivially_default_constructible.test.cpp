...
TEST_CASE("is_trivially_default_constructible")
{
    ...
    test_is_trivially_default_constructible<enum_type>();
    test_is_trivially_default_constructible<enum_signed>();
    test_is_trivially_default_constructible<enum_unsigned>();
    test_is_trivially_default_constructible<enum_class>();
    test_is_trivially_default_constructible<enum_struct>();
