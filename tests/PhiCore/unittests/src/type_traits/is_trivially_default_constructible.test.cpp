...
TEST_CASE("is_trivially_default_constructible")
{
    ...
    test_is_trivially_default_constructible<Template<incomplete_type>>();
    ...
    test_is_trivially_default_constructible<VariadicTemplate<incomplete_type>>();
    test_is_trivially_default_constructible<VariadicTemplate<int, void, Class, volatile char[]>>();
    test_is_trivially_default_constructible<PublicDerviedFromTemplate<Base>>();
    test_is_trivially_default_constructible<PublicDerviedFromTemplate<Derived>>();
    test_is_not_trivially_default_constructible<PublicDerviedFromTemplate<Class>>();
    test_is_trivially_default_constructible<PrivateDerviedFromTemplate<Base>>();
    test_is_trivially_default_constructible<PrivateDerviedFromTemplate<Derived>>();
    test_is_not_trivially_default_constructible<PrivateDerviedFromTemplate<Class>>();
    test_is_trivially_default_constructible<ProtectedDerviedFromTemplate<Base>>();
    test_is_trivially_default_constructible<ProtectedDerviedFromTemplate<Derived>>();
    test_is_not_trivially_default_constructible<ProtectedDerviedFromTemplate<Class>>();
    ...
    test_is_not_trivially_default_constructible<AbstractTemplate<incomplete_type>>();
