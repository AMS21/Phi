...
TEST_CASE("is_member_function_pointer")
{
    ...
    test_is_not_member_function_pointer<enum_type>();
    test_is_not_member_function_pointer<enum_signed>();
    test_is_not_member_function_pointer<enum_unsigned>();
    test_is_not_member_function_pointer<enum_class>();
    test_is_not_member_function_pointer<enum_struct>();
    ...
    test_is_not_member_function_pointer<IncompleteVariadicTemplate<class_type>>();
