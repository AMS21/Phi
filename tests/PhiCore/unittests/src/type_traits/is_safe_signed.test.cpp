...
void test_is_safe_signed_impl()
{
    ...
    TEST_TYPE_TRAITS_TYPE_DEFS(phi::is_safe_signed<T>);
    TEST_TYPE_TRAITS_TYPE_DEFS(phi::is_not_safe_signed<T>);
}
...
TEST_CASE("is_safe_signed")
{
    ...
    test_is_not_safe_signed<ExplicitTo<class_type>>();
    ...
    test_is_not_safe_signed<enum_type>();
    test_is_not_safe_signed<enum_signed>();
    test_is_not_safe_signed<enum_unsigned>();
    test_is_not_safe_signed<enum_class>();
    test_is_not_safe_signed<enum_struct>();
    ...
    test_is_not_safe_signed<IncompleteVariadicTemplate<class_type>>();
    test_is_not_safe_signed<IncompleteVariadicTemplate<incomplete_type>>();
    test_is_not_safe_signed<IncompleteVariadicTemplate<int, void, class_type, volatile char[]>>();
    test_is_not_safe_signed<incomplete_union>();
    test_is_not_safe_signed<incomplete_enum_signed>();
    test_is_not_safe_signed<incomplete_enum_unsigned>();
    test_is_not_safe_signed<incomplete_enum_class>();
    test_is_not_safe_signed<incomplete_enum_struct>();
