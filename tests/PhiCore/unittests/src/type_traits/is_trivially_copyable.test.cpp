...
TEST_CASE("is_trivially_copyable")
{
    ...
    test_is_trivially_copyable<Template<IncompleteType>>();
    ...
    test_is_trivially_copyable<VariadicTemplate<IncompleteType>>();
    test_is_trivially_copyable<VariadicTemplate<int, void, Class, volatile char[]>>();
    test_is_trivially_copyable<PublicDerivedFromTemplate<Base>>();
    test_is_trivially_copyable<PublicDerivedFromTemplate<Derived>>();
    test_is_not_trivially_copyable<PublicDerivedFromTemplate<Class>>();
    test_is_trivially_copyable<PrivateDerivedFromTemplate<Base>>();
    test_is_trivially_copyable<PrivateDerivedFromTemplate<Derived>>();
    test_is_not_trivially_copyable<PrivateDerivedFromTemplate<Class>>();
    test_is_trivially_copyable<ProtectedDerivedFromTemplate<Base>>();
    test_is_trivially_copyable<ProtectedDerivedFromTemplate<Derived>>();
    test_is_not_trivially_copyable<ProtectedDerivedFromTemplate<Class>>();
    ...
    test_is_trivially_copyable<BitZero>();
    test_is_trivially_copyable<BitOne>();
    ...
    test_is_not_trivially_copyable<AbstractTemplate<IncompleteType>>();
