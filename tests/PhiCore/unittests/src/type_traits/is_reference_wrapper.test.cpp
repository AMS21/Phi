...
TEST_CASE("is_refenrece_wrapper")
{
    ...
    test_is_not_reference_wrapper<Template<incomplete_type>>();
    ...
    test_is_not_reference_wrapper<VariadicTemplate<incomplete_type>>();
    test_is_not_reference_wrapper<VariadicTemplate<int, void, Class, volatile char[]>>();
    test_is_not_reference_wrapper<PublicDerviedFromTemplate<Base>>();
    test_is_not_reference_wrapper<PublicDerviedFromTemplate<Derived>>();
    test_is_not_reference_wrapper<PublicDerviedFromTemplate<Class>>();
    test_is_not_reference_wrapper<PrivateDerviedFromTemplate<Base>>();
    test_is_not_reference_wrapper<PrivateDerviedFromTemplate<Derived>>();
    test_is_not_reference_wrapper<PrivateDerviedFromTemplate<Class>>();
    test_is_not_reference_wrapper<ProtectedDerviedFromTemplate<Base>>();
    test_is_not_reference_wrapper<ProtectedDerviedFromTemplate<Derived>>();
    test_is_not_reference_wrapper<ProtectedDerviedFromTemplate<Class>>();
    ...
    test_is_not_reference_wrapper<AbstractTemplate<incomplete_type>>();
    ...
    test_is_not_reference_wrapper<IncompleteTemplate<incomplete_type>>();
