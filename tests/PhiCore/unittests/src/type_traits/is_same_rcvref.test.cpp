...
TEST_CASE("is_same_rcvref")
{
    ...
    test_is_same_rcvref<ExplicitTo<class_type>>();
    ...
    test_is_same_rcvref<enum_type>();
    test_is_same_rcvref<enum_signed>();
    test_is_same_rcvref<enum_unsigned>();
    test_is_same_rcvref<enum_class>();
    test_is_same_rcvref<enum_struct>();
    ...
    test_is_same_rcvref<IncompleteVariadicTemplate<class_type>>();
    test_is_same_rcvref<IncompleteVariadicTemplate<incomplete_type>>();
    test_is_same_rcvref<IncompleteVariadicTemplate<int, void, class_type, volatile char[]>>();
    test_is_same_rcvref<incomplete_union>();
    test_is_same_rcvref<incomplete_enum_signed>();
    test_is_same_rcvref<incomplete_enum_unsigned>();
    test_is_same_rcvref<incomplete_enum_class>();
    test_is_same_rcvref<incomplete_enum_struct>();
    test_is_same_rcvref<int class_type::*>();
    test_is_same_rcvref<float class_type::*>();
    test_is_same_rcvref<void * class_type::*>();
    test_is_same_rcvref<int * class_type::*>();
    test_is_same_rcvref<enum_type class_type::*>();
