...
TEST_CASE("remove_all_extents")
{
    ...
    test_remove_all_extents<Template<IncompleteType>>();
    ...
    test_remove_all_extents<VariadicTemplate<IncompleteType>>();
    test_remove_all_extents<VariadicTemplate<int, void, Class, volatile char[]>>();
    test_remove_all_extents<PublicDerivedFromTemplate<Base>>();
    test_remove_all_extents<PublicDerivedFromTemplate<Derived>>();
    test_remove_all_extents<PublicDerivedFromTemplate<Class>>();
    test_remove_all_extents<PrivateDerivedFromTemplate<Base>>();
    test_remove_all_extents<PrivateDerivedFromTemplate<Derived>>();
    test_remove_all_extents<PrivateDerivedFromTemplate<Class>>();
    test_remove_all_extents<ProtectedDerivedFromTemplate<Base>>();
    test_remove_all_extents<ProtectedDerivedFromTemplate<Derived>>();
    test_remove_all_extents<ProtectedDerivedFromTemplate<Class>>();
    ...
    test_remove_all_extents<BitZero>();
    test_remove_all_extents<BitOne>();
    ...
    test_remove_all_extents<AbstractTemplate<IncompleteType>>();
    ...
    test_remove_all_extents<IncompleteType>();
    ...
    test_remove_all_extents<IncompleteTemplate<IncompleteType>>();
    ...
    test_remove_all_extents<IncompleteVariadicTemplate<IncompleteType>>();
