...
TEST_CASE("remove_all_extents")
{
    ...
    test_remove_all_extents<phi::floating_point<float>, phi::floating_point<float>>();
    test_remove_all_extents<phi::floating_point<double>, phi::floating_point<double>>();
    test_remove_all_extents<phi::floating_point<long double>, phi::floating_point<long double>>();

    test_remove_all_extents<std::vector<int>, std::vector<int>>();
    test_remove_all_extents<phi::scope_ptr<int>, phi::scope_ptr<int>>();
