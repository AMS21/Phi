...
TEST_CASE("remove_all_extents")
{
    ...
    test_remove_all_extents<enum_type>();
    test_remove_all_extents<enum_signed>();
    test_remove_all_extents<enum_unsigned>();
    test_remove_all_extents<enum_class>();
    test_remove_all_extents<enum_struct>();
    ...
    test_remove_all_extents<IncompleteVariadicTemplate<class_type>>();
    test_remove_all_extents<IncompleteVariadicTemplate<incomplete_type>>();
    test_remove_all_extents<IncompleteVariadicTemplate<int, void, class_type, volatile char[]>>();
