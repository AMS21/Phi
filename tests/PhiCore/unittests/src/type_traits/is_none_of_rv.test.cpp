...
{
    STATIC_REQUIRE(phi::is_none_of_rv<T, Args...>::value);

#if PHI_HAS_FEATURE_VARIABLE_TEMPLATE()
    STATIC_REQUIRE(phi::is_none_of_rv_v<T, Args...>);
#endif

    TEST_TYPE_TRAITS_TYPE_DEFS(phi::is_none_of_rv<T, Args...>);
}

template <typename T, typename... Args>
void test_is_not_none_of_rv()
{
    STATIC_REQUIRE_FALSE(phi::is_none_of_rv<T, Args...>::value);

#if PHI_HAS_FEATURE_VARIABLE_TEMPLATE()
    STATIC_REQUIRE_FALSE(phi::is_none_of_rv_v<T, Args...>);
#endif
