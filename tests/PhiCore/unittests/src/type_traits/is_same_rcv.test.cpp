...
TEST_CASE("is_same_rcv")
{
    ...
    test_is_same_rcv<ExplicitTo<class_type>>();
    ...
    test_is_same_rcv<enum_type>();
    test_is_same_rcv<enum_signed>();
    test_is_same_rcv<enum_unsigned>();
    test_is_same_rcv<enum_class>();
    test_is_same_rcv<enum_struct>();
    ...
    test_is_same_rcv<IncompleteVariadicTemplate<class_type>>();
    test_is_same_rcv<IncompleteVariadicTemplate<incomplete_type>>();
    test_is_same_rcv<IncompleteVariadicTemplate<int, void, class_type, volatile char[]>>();
    test_is_same_rcv<incomplete_union>();
    test_is_same_rcv<incomplete_enum_signed>();
    test_is_same_rcv<incomplete_enum_unsigned>();
    test_is_same_rcv<incomplete_enum_class>();
    test_is_same_rcv<incomplete_enum_struct>();
    test_is_same_rcv<int class_type::*>();
    test_is_same_rcv<float class_type::*>();
    test_is_same_rcv<void * class_type::*>();
    test_is_same_rcv<int * class_type::*>();
    test_is_same_rcv<enum_type class_type::*>();
