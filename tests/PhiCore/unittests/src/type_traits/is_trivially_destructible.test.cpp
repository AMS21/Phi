...
TEST_CASE("is_trivially_destructible")
{
    ...
    test_is_trivially_destructible<Template<IncompleteType>>();
    ...
    test_is_trivially_destructible<VariadicTemplate<IncompleteType>>();
    test_is_trivially_destructible<VariadicTemplate<int, void, Class, volatile char[]>>();
    test_is_trivially_destructible<PublicDerivedFromTemplate<Base>>();
    test_is_trivially_destructible<PublicDerivedFromTemplate<Derived>>();
    test_is_not_trivially_destructible<PublicDerivedFromTemplate<Class>>();
    test_is_trivially_destructible<PrivateDerivedFromTemplate<Base>>();
    test_is_trivially_destructible<PrivateDerivedFromTemplate<Derived>>();
    test_is_not_trivially_destructible<PrivateDerivedFromTemplate<Class>>();
    test_is_trivially_destructible<ProtectedDerivedFromTemplate<Base>>();
    test_is_trivially_destructible<ProtectedDerivedFromTemplate<Derived>>();
    test_is_not_trivially_destructible<ProtectedDerivedFromTemplate<Class>>();
    ...
    test_is_trivially_destructible<BitZero>();
    test_is_trivially_destructible<BitOne>();
    ...
    test_is_not_trivially_destructible<AbstractTemplate<IncompleteType>>();
