...
TEST_CASE("is_arithmetic")
{
    ...
    test_is_not_arithmetic<enum_type>();
    test_is_not_arithmetic<enum_signed>();
    test_is_not_arithmetic<enum_unsigned>();
    test_is_not_arithmetic<enum_class>();
    test_is_not_arithmetic<enum_struct>();
    ...
    test_is_not_arithmetic<IncompleteVariadicTemplate<class_type>>();
    test_is_not_arithmetic<IncompleteVariadicTemplate<incomplete_type>>();
    test_is_not_arithmetic<IncompleteVariadicTemplate<int, void, class_type, volatile char[]>>();
