...
TEST_CASE("is_member_pointer")
{
    ...
    test_is_not_member_pointer<Template<incomplete_type>>();
    ...
    test_is_not_member_pointer<VariadicTemplate<incomplete_type>>();
    test_is_not_member_pointer<VariadicTemplate<int, void, Class, volatile char[]>>();
    test_is_not_member_pointer<PublicDerviedFromTemplate<Base>>();
    test_is_not_member_pointer<PublicDerviedFromTemplate<Derived>>();
    test_is_not_member_pointer<PublicDerviedFromTemplate<Class>>();
    test_is_not_member_pointer<PrivateDerviedFromTemplate<Base>>();
    test_is_not_member_pointer<PrivateDerviedFromTemplate<Derived>>();
    test_is_not_member_pointer<PrivateDerviedFromTemplate<Class>>();
    test_is_not_member_pointer<ProtectedDerviedFromTemplate<Base>>();
    test_is_not_member_pointer<ProtectedDerviedFromTemplate<Derived>>();
    test_is_not_member_pointer<ProtectedDerviedFromTemplate<Class>>();
    ...
    test_is_not_member_pointer<AbstractTemplate<incomplete_type>>();
    ...
    test_is_not_member_pointer<IncompleteTemplate<incomplete_type>>();
