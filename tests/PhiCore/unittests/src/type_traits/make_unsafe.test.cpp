...
TEST_CASE("make_unsafe")
{
    ...
    test_make_unsafe<enum_type>();
    test_make_unsafe<enum_signed>();
    test_make_unsafe<enum_unsigned>();
    test_make_unsafe<enum_class>();
    test_make_unsafe<enum_struct>();
    ...
    test_make_unsafe<IncompleteVariadicTemplate<class_type>>();
    test_make_unsafe<IncompleteVariadicTemplate<incomplete_type>>();
    test_make_unsafe<IncompleteVariadicTemplate<int, void, class_type, volatile char[]>>();
