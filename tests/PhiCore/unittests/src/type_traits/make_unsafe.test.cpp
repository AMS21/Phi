...
TEST_CASE("make_unsafe")
{
    ...
    test_make_unsafe<Template<incomplete_type>>();
    ...
    test_make_unsafe<VariadicTemplate<incomplete_type>>();
    test_make_unsafe<VariadicTemplate<int, void, Class, volatile char[]>>();
    test_make_unsafe<PublicDerviedFromTemplate<Base>>();
    test_make_unsafe<PublicDerviedFromTemplate<Derived>>();
    test_make_unsafe<PublicDerviedFromTemplate<Class>>();
    test_make_unsafe<PrivateDerviedFromTemplate<Base>>();
    test_make_unsafe<PrivateDerviedFromTemplate<Derived>>();
    test_make_unsafe<PrivateDerviedFromTemplate<Class>>();
    test_make_unsafe<ProtectedDerviedFromTemplate<Base>>();
    test_make_unsafe<ProtectedDerviedFromTemplate<Derived>>();
    test_make_unsafe<ProtectedDerviedFromTemplate<Class>>();
    ...
    test_make_unsafe<AbstractTemplate<incomplete_type>>();
    ...
    test_make_unsafe<IncompleteTemplate<incomplete_type>>();
    ...
    test_make_unsafe<IncompleteVariadicTemplate<incomplete_type>>();
