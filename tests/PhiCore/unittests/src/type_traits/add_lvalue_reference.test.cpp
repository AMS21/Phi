...
TEST_CASE("add_lvalue_reference")
{
    ...
    test_add_lvalue_reference<phi::floating_point<float>, phi::floating_point<float>&>();
    test_add_lvalue_reference<phi::floating_point<double>, phi::floating_point<double>&>();
    ...
    test_add_lvalue_reference<phi::scope_ptr<int>, phi::scope_ptr<int>&>();
