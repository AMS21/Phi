...
TEST_CASE("add_lvalue_reference")
{
    ...
    test_add_lvalue_reference<ExplicitTo<class_type>>();
    ...
    test_add_lvalue_reference<enum_type>();
    test_add_lvalue_reference<enum_signed>();
    test_add_lvalue_reference<enum_unsigned>();
    test_add_lvalue_reference<enum_class>();
    test_add_lvalue_reference<enum_struct>();
    ...
    test_add_lvalue_reference<IncompleteVariadicTemplate<class_type>>();
    test_add_lvalue_reference<IncompleteVariadicTemplate<incomplete_type>>();
    test_add_lvalue_reference<IncompleteVariadicTemplate<int, void, class_type, volatile char[]>>();
    test_add_lvalue_reference<incomplete_union>();
    test_add_lvalue_reference<incomplete_enum_signed>();
    test_add_lvalue_reference<incomplete_enum_unsigned>();
    test_add_lvalue_reference<incomplete_enum_class>();
    test_add_lvalue_reference<incomplete_enum_struct>();
    ...
    test_add_lvalue_reference<int * class_type::*>();
    test_add_lvalue_reference<enum_type class_type::*>();
