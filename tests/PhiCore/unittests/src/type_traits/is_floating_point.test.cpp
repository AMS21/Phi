...
TEST_CASE("is_floating_point")
{
    ...
    test_is_not_floating_point<final_type>();
    test_is_not_floating_point<enum_type>();
    test_is_not_floating_point<enum_signed>();
    test_is_not_floating_point<enum_unsigned>();
    test_is_not_floating_point<enum_class>();
    test_is_not_floating_point<enum_struct>();
    ...
    test_is_not_floating_point<IncompleteVariadicTemplate<class_type>>();
