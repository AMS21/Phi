...
TEST_CASE("is_move_constructible")
{
    ...
    test_is_move_constructible_cv<enum_type>();
    test_is_move_constructible_cv<enum_signed>();
    test_is_move_constructible_cv<enum_unsigned>();
    test_is_move_constructible_cv<enum_class>();
    test_is_move_constructible_cv<enum_struct>();
