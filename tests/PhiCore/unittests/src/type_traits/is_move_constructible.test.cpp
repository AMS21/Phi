...
TEST_CASE("is_move_constructible")
{
    ...
    test_is_move_constructible_c<Template<IncompleteType>>();
    ...
    test_is_move_constructible_c<VariadicTemplate<IncompleteType>>();
    test_is_move_constructible_c<VariadicTemplate<int, void, Class, volatile char[]>>();
    test_is_move_constructible_c<PublicDerivedFromTemplate<Base>>();
    test_is_move_constructible_c<PublicDerivedFromTemplate<Derived>>();
    test_is_move_constructible_c<PublicDerivedFromTemplate<Class>>();
    test_is_move_constructible_c<PrivateDerivedFromTemplate<Base>>();
    test_is_move_constructible_c<PrivateDerivedFromTemplate<Derived>>();
    test_is_move_constructible_c<PrivateDerivedFromTemplate<Class>>();
    test_is_move_constructible_c<ProtectedDerivedFromTemplate<Base>>();
    test_is_move_constructible_c<ProtectedDerivedFromTemplate<Derived>>();
    test_is_move_constructible_c<ProtectedDerivedFromTemplate<Class>>();
    ...
    test_is_move_constructible_c<BitZero>();
    test_is_move_constructible_c<BitOne>();
    ...
    test_is_not_move_constructible_cv<AbstractTemplate<IncompleteType>>();
#endif
