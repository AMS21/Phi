...
TEST_CASE("is_referenceable")
{
    ...
    test_is_referenceable<ExplicitTo<class_type>>();
    ...
    test_is_referenceable<enum_type>();
    test_is_referenceable<enum_signed>();
    test_is_referenceable<enum_unsigned>();
    test_is_referenceable<enum_class>();
    test_is_referenceable<enum_struct>();
    ...
    test_is_referenceable<IncompleteVariadicTemplate<class_type>>();
    test_is_referenceable<IncompleteVariadicTemplate<incomplete_type>>();
    test_is_referenceable<IncompleteVariadicTemplate<int, void, class_type, volatile char[]>>();
    test_is_referenceable<incomplete_union>();
    test_is_referenceable<incomplete_enum_signed>();
    test_is_referenceable<incomplete_enum_unsigned>();
    test_is_referenceable<incomplete_enum_class>();
    test_is_referenceable<incomplete_enum_struct>();
