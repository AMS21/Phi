...
TEST_CASE("remove_cvref")
{
    ...
    test_remove_cvref<enum_type>();
    test_remove_cvref<enum_signed>();
    test_remove_cvref<enum_unsigned>();
    test_remove_cvref<enum_class>();
    test_remove_cvref<enum_struct>();
    ...
    test_remove_cvref<IncompleteVariadicTemplate<class_type>>();
    test_remove_cvref<IncompleteVariadicTemplate<incomplete_type>>();
    test_remove_cvref<IncompleteVariadicTemplate<int, void, class_type, volatile char[]>>();
