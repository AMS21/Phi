...
TEST_CASE("remove_cvref")
{
    ...
    test_remove_cvref<Template<incomplete_type>>();
    ...
    test_remove_cvref<VariadicTemplate<incomplete_type>>();
    test_remove_cvref<VariadicTemplate<int, void, Class, volatile char[]>>();
    test_remove_cvref<PublicDerviedFromTemplate<Base>>();
    test_remove_cvref<PublicDerviedFromTemplate<Derived>>();
    test_remove_cvref<PublicDerviedFromTemplate<Class>>();
    test_remove_cvref<PrivateDerviedFromTemplate<Base>>();
    test_remove_cvref<PrivateDerviedFromTemplate<Derived>>();
    test_remove_cvref<PrivateDerviedFromTemplate<Class>>();
    test_remove_cvref<ProtectedDerviedFromTemplate<Base>>();
    test_remove_cvref<ProtectedDerviedFromTemplate<Derived>>();
    test_remove_cvref<ProtectedDerviedFromTemplate<Class>>();
    ...
    test_remove_cvref<AbstractTemplate<incomplete_type>>();
    ...
    test_remove_cvref<IncompleteTemplate<incomplete_type>>();
    ...
    test_remove_cvref<IncompleteVariadicTemplate<incomplete_type>>();
