...
TEST_CASE("is_volatile")
{
    ...
    test_is_volatile<enum_type>();
    test_is_volatile<enum_signed>();
    test_is_volatile<enum_unsigned>();
    test_is_volatile<enum_class>();
    test_is_volatile<enum_struct>();
    ...
    test_is_volatile<IncompleteVariadicTemplate<class_type>>();
    test_is_volatile<IncompleteVariadicTemplate<incomplete_type>>();
    test_is_volatile<IncompleteVariadicTemplate<int, void, class_type, volatile char[]>>();
