...
TEST_CASE("is_volatile")
{
    ...
    test_is_volatile<Template<incomplete_type>>();
    ...
    test_is_volatile<VariadicTemplate<incomplete_type>>();
    test_is_volatile<VariadicTemplate<int, void, Class, volatile char[]>>();
    test_is_volatile<PublicDerviedFromTemplate<Base>>();
    test_is_volatile<PublicDerviedFromTemplate<Derived>>();
    test_is_volatile<PublicDerviedFromTemplate<Class>>();
    test_is_volatile<PrivateDerviedFromTemplate<Base>>();
    test_is_volatile<PrivateDerviedFromTemplate<Derived>>();
    test_is_volatile<PrivateDerviedFromTemplate<Class>>();
    test_is_volatile<ProtectedDerviedFromTemplate<Base>>();
    test_is_volatile<ProtectedDerviedFromTemplate<Derived>>();
    test_is_volatile<ProtectedDerviedFromTemplate<Class>>();
    ...
    test_is_volatile<IncompleteTemplate<incomplete_type>>();
    ...
    test_is_volatile<IncompleteVariadicTemplate<incomplete_type>>();
