...
TEST_CASE("remove_extent")
{
    ...
    test_remove_extent<Template<incomplete_type>>();
    ...
    test_remove_extent<VariadicTemplate<incomplete_type>>();
    test_remove_extent<VariadicTemplate<int, void, Class, volatile char[]>>();
    test_remove_extent<PublicDerviedFromTemplate<Base>>();
    test_remove_extent<PublicDerviedFromTemplate<Derived>>();
    test_remove_extent<PublicDerviedFromTemplate<Class>>();
    test_remove_extent<PrivateDerviedFromTemplate<Base>>();
    test_remove_extent<PrivateDerviedFromTemplate<Derived>>();
    test_remove_extent<PrivateDerviedFromTemplate<Class>>();
    test_remove_extent<ProtectedDerviedFromTemplate<Base>>();
    test_remove_extent<ProtectedDerviedFromTemplate<Derived>>();
    test_remove_extent<ProtectedDerviedFromTemplate<Class>>();
    ...
    test_remove_extent<AbstractTemplate<incomplete_type>>();
    ...
    test_remove_extent<IncompleteTemplate<incomplete_type>>();
    ...
    test_remove_extent<IncompleteVariadicTemplate<incomplete_type>>();
