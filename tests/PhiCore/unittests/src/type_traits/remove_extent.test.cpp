...
TEST_CASE("remove_extent")
{
    ...
    test_remove_extent<enum_type>();
    test_remove_extent<enum_signed>();
    test_remove_extent<enum_unsigned>();
    test_remove_extent<enum_class>();
    test_remove_extent<enum_struct>();
    ...
    test_remove_extent<IncompleteVariadicTemplate<class_type>>();
    test_remove_extent<IncompleteVariadicTemplate<incomplete_type>>();
    test_remove_extent<IncompleteVariadicTemplate<int, void, class_type, volatile char[]>>();
