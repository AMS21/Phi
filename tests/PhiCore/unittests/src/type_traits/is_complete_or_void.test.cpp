...
void test_is_complete_or_void_impl()
{
    ...
    TEST_TYPE_TRAITS_TYPE_DEFS(phi::is_complete_or_void<T>);
    TEST_TYPE_TRAITS_TYPE_DEFS(phi::is_not_complete_or_void<T>);
}
...
TEST_CASE("is_complete_or_void")
{
    ...
    test_is_complete_or_void<Template<IncompleteType>>();
    ...
    test_is_complete_or_void<VariadicTemplate<IncompleteType>>();
    test_is_complete_or_void<VariadicTemplate<int, void, Class, volatile char[]>>();
    test_is_complete_or_void<PublicDerivedFromTemplate<Base>>();
    test_is_complete_or_void<PublicDerivedFromTemplate<Derived>>();
    test_is_complete_or_void<PublicDerivedFromTemplate<Class>>();
    test_is_complete_or_void<PrivateDerivedFromTemplate<Base>>();
    test_is_complete_or_void<PrivateDerivedFromTemplate<Derived>>();
    test_is_complete_or_void<PrivateDerivedFromTemplate<Class>>();
    test_is_complete_or_void<ProtectedDerivedFromTemplate<Base>>();
    test_is_complete_or_void<ProtectedDerivedFromTemplate<Derived>>();
    test_is_complete_or_void<ProtectedDerivedFromTemplate<Class>>();
    ...
    test_is_complete_or_void<BitZero>();
    test_is_complete_or_void<BitOne>();
    ...
    test_is_complete_or_void<AbstractTemplate<IncompleteType>>();
    ...
    test_is_not_complete_or_void<IncompleteType>();
    ...
    test_is_not_complete_or_void<IncompleteTemplate<IncompleteType>>();
    ...
    test_is_not_complete_or_void<IncompleteVariadicTemplate<IncompleteType>>();
