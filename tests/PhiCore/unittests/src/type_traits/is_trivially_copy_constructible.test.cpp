...
TEST_CASE("is_trivially_copy_constructible")
{
    ...
    test_is_trivially_copy_constructible_cv<enum_type>();
    test_is_trivially_copy_constructible_cv<enum_signed>();
    test_is_trivially_copy_constructible_cv<enum_unsigned>();
    test_is_trivially_copy_constructible_cv<enum_class>();
    test_is_trivially_copy_constructible_cv<enum_struct>();
