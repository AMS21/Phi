...
TEST_CASE("is_trivially_copy_constructible")
{
    ...
    test_is_trivially_copy_constructible<Template<incomplete_type>>();
    ...
    test_is_trivially_copy_constructible<VariadicTemplate<incomplete_type>>();
    test_is_trivially_copy_constructible<VariadicTemplate<int, void, Class, volatile char[]>>();
    test_is_trivially_copy_constructible<PublicDerviedFromTemplate<Base>>();
    test_is_trivially_copy_constructible<PublicDerviedFromTemplate<Derived>>();
    test_is_not_trivially_copy_constructible<PublicDerviedFromTemplate<Class>>();
    test_is_trivially_copy_constructible<PrivateDerviedFromTemplate<Base>>();
    test_is_trivially_copy_constructible<PrivateDerviedFromTemplate<Derived>>();
    test_is_not_trivially_copy_constructible<PrivateDerviedFromTemplate<Class>>();
    test_is_trivially_copy_constructible<ProtectedDerviedFromTemplate<Base>>();
    test_is_trivially_copy_constructible<ProtectedDerviedFromTemplate<Derived>>();
    test_is_not_trivially_copy_constructible<ProtectedDerviedFromTemplate<Class>>();
    ...
    test_is_not_trivially_copy_constructible<AbstractTemplate<incomplete_type>>();
