...
TEST_CASE("is_unsafe_integer")
{
    ...
    test_is_not_unsafe_integer<enum_type>();
    test_is_not_unsafe_integer<enum_signed>();
    test_is_not_unsafe_integer<enum_unsigned>();
    test_is_not_unsafe_integer<enum_class>();
    test_is_not_unsafe_integer<enum_struct>();
    ...
    test_is_not_unsafe_integer<IncompleteVariadicTemplate<class_type>>();
