...
TEST_CASE("is_unsafe_integer")
{
    ...
    test_is_not_unsafe_integer<Template<incomplete_type>>();
    ...
    test_is_not_unsafe_integer<VariadicTemplate<incomplete_type>>();
    test_is_not_unsafe_integer<VariadicTemplate<int, void, Class, volatile char[]>>();
    test_is_not_unsafe_integer<PublicDerviedFromTemplate<Base>>();
    test_is_not_unsafe_integer<PublicDerviedFromTemplate<Derived>>();
    test_is_not_unsafe_integer<PublicDerviedFromTemplate<Class>>();
    test_is_not_unsafe_integer<PrivateDerviedFromTemplate<Base>>();
    test_is_not_unsafe_integer<PrivateDerviedFromTemplate<Derived>>();
    test_is_not_unsafe_integer<PrivateDerviedFromTemplate<Class>>();
    test_is_not_unsafe_integer<ProtectedDerviedFromTemplate<Base>>();
    test_is_not_unsafe_integer<ProtectedDerviedFromTemplate<Derived>>();
    test_is_not_unsafe_integer<ProtectedDerviedFromTemplate<Class>>();
    ...
    test_is_not_unsafe_integer<IncompleteTemplate<incomplete_type>>();
    ...
    test_is_not_unsafe_integer<IncompleteVariadicTemplate<incomplete_type>>();
