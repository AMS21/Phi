...
TEST_CASE("is_safe_arithmetic")
{
    ...
    test_is_not_safe_arithmetic<Template<incomplete_type>>();
    ...
    test_is_not_safe_arithmetic<VariadicTemplate<incomplete_type>>();
    test_is_not_safe_arithmetic<VariadicTemplate<int, void, Class, volatile char[]>>();
    test_is_not_safe_arithmetic<PublicDerviedFromTemplate<Base>>();
    test_is_not_safe_arithmetic<PublicDerviedFromTemplate<Derived>>();
    test_is_not_safe_arithmetic<PublicDerviedFromTemplate<Class>>();
    test_is_not_safe_arithmetic<PrivateDerviedFromTemplate<Base>>();
    test_is_not_safe_arithmetic<PrivateDerviedFromTemplate<Derived>>();
    test_is_not_safe_arithmetic<PrivateDerviedFromTemplate<Class>>();
    test_is_not_safe_arithmetic<ProtectedDerviedFromTemplate<Base>>();
    test_is_not_safe_arithmetic<ProtectedDerviedFromTemplate<Derived>>();
    test_is_not_safe_arithmetic<ProtectedDerviedFromTemplate<Class>>();
    ...
    test_is_not_safe_arithmetic<IncompleteTemplate<incomplete_type>>();
