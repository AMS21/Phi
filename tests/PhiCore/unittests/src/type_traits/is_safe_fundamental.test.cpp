...
TEST_CASE("is_safe_fundamental")
{
    ...
    test_is_not_safe_fundamental<ExplicitTo<class_type>>();
    ...
    test_is_not_safe_fundamental<public_static_tempalte_member<int>>();
    test_is_not_safe_fundamental<public_static_tempalte_member<float>>();
    test_is_not_safe_fundamental<public_static_tempalte_member<class_type>>();
    ...
    test_is_not_safe_fundamental<enum_type>();
    test_is_not_safe_fundamental<enum_signed>();
    test_is_not_safe_fundamental<enum_unsigned>();
    test_is_not_safe_fundamental<enum_class>();
    test_is_not_safe_fundamental<enum_struct>();
    ...
    test_is_not_safe_fundamental<IncompleteVariadicTemplate<class_type>>();
    test_is_not_safe_fundamental<IncompleteVariadicTemplate<incomplete_type>>();
    ...
    test_is_not_safe_fundamental<incomplete_enum_signed>();
    test_is_not_safe_fundamental<incomplete_enum_unsigned>();
    test_is_not_safe_fundamental<incomplete_enum_class>();
    test_is_not_safe_fundamental<incomplete_enum_struct>();
