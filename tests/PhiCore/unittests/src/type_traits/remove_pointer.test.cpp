...
TEST_CASE("remove_pointer")
{
    ...
    test_remove_pointer<Template<incomplete_type>>();
    ...
    test_remove_pointer<VariadicTemplate<incomplete_type>>();
    test_remove_pointer<VariadicTemplate<int, void, Class, volatile char[]>>();
    test_remove_pointer<PublicDerviedFromTemplate<Base>>();
    test_remove_pointer<PublicDerviedFromTemplate<Derived>>();
    test_remove_pointer<PublicDerviedFromTemplate<Class>>();
    test_remove_pointer<PrivateDerviedFromTemplate<Base>>();
    test_remove_pointer<PrivateDerviedFromTemplate<Derived>>();
    test_remove_pointer<PrivateDerviedFromTemplate<Class>>();
    test_remove_pointer<ProtectedDerviedFromTemplate<Base>>();
    test_remove_pointer<ProtectedDerviedFromTemplate<Derived>>();
    test_remove_pointer<ProtectedDerviedFromTemplate<Class>>();
    ...
    test_remove_pointer<AbstractTemplate<incomplete_type>>();
    ...
    test_remove_pointer<IncompleteTemplate<incomplete_type>>();
    ...
    test_remove_pointer<IncompleteVariadicTemplate<incomplete_type>>();
