...
TEST_CASE("remove_pointer")
{
    ...
    test_remove_pointer<enum_type>();
    test_remove_pointer<enum_signed>();
    test_remove_pointer<enum_unsigned>();
    test_remove_pointer<enum_class>();
    test_remove_pointer<enum_struct>();
    ...
    test_remove_pointer<IncompleteVariadicTemplate<class_type>>();
    test_remove_pointer<IncompleteVariadicTemplate<incomplete_type>>();
    test_remove_pointer<IncompleteVariadicTemplate<int, void, class_type, volatile char[]>>();
