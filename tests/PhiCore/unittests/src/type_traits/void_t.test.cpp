...
TEST_CASE("is_void")
{
    ...
    test_void_t<enum_type>();
    test_void_t<enum_signed>();
    test_void_t<enum_unsigned>();
    test_void_t<enum_class>();
    test_void_t<enum_struct>();
    ...
    test_void_t<IncompleteVariadicTemplate<class_type>>();
    test_void_t<IncompleteVariadicTemplate<incomplete_type>>();
    test_void_t<IncompleteVariadicTemplate<int, void, class_type, volatile char[]>>();
