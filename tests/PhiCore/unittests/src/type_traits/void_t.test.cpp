...
TEST_CASE("is_void")
{
    ...
    test_void_t<Template<IncompleteType>>();
    ...
    test_void_t<VariadicTemplate<IncompleteType>>();
    test_void_t<VariadicTemplate<int, void, Class, volatile char[]>>();
    test_void_t<PublicDerivedFromTemplate<Base>>();
    test_void_t<PublicDerivedFromTemplate<Derived>>();
    test_void_t<PublicDerivedFromTemplate<Class>>();
    test_void_t<PrivateDerivedFromTemplate<Base>>();
    test_void_t<PrivateDerivedFromTemplate<Derived>>();
    test_void_t<PrivateDerivedFromTemplate<Class>>();
    test_void_t<ProtectedDerivedFromTemplate<Base>>();
    test_void_t<ProtectedDerivedFromTemplate<Derived>>();
    test_void_t<ProtectedDerivedFromTemplate<Class>>();
    test_void_t<Union>();
    ...
    test_void_t<AbstractTemplate<IncompleteType>>();
    test_void_t<Final>();
    ...
    test_void_t<IncompleteVariadicTemplate<IncompleteType>>();
