...
TEST_CASE("is_copy_assignable")
{
    ...
    test_is_copy_assignable<Template<IncompleteType>>();
    ...
    test_is_copy_assignable<VariadicTemplate<IncompleteType>>();
    test_is_copy_assignable<VariadicTemplate<int, void, Class, volatile char[]>>();
    test_is_copy_assignable<PublicDerivedFromTemplate<Base>>();
    test_is_copy_assignable<PublicDerivedFromTemplate<Derived>>();
    test_is_copy_assignable<PublicDerivedFromTemplate<Class>>();
    test_is_copy_assignable<PrivateDerivedFromTemplate<Base>>();
    test_is_copy_assignable<PrivateDerivedFromTemplate<Derived>>();
    test_is_copy_assignable<PrivateDerivedFromTemplate<Class>>();
    test_is_copy_assignable<ProtectedDerivedFromTemplate<Base>>();
    test_is_copy_assignable<ProtectedDerivedFromTemplate<Derived>>();
    test_is_copy_assignable<ProtectedDerivedFromTemplate<Class>>();
    ...
    test_is_copy_assignable<BitZero>();
    test_is_copy_assignable<BitOne>();
    ...
    test_is_copy_assignable<AbstractTemplate<IncompleteType>>();
    ...
    //test_is_not_copy_assignable<IncompleteType>();
    ...
    //test_is_not_copy_assignable<IncompleteTemplate<IncompleteType>>();
    ...
    //test_is_not_copy_assignable<IncompleteVariadicTemplate<IncompleteType>>();
