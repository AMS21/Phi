...
TEST_CASE("is_copy_assignable")
{
    ...
    test_is_copy_assignable<enum_type>();
    test_is_copy_assignable<enum_signed>();
    test_is_copy_assignable<enum_unsigned>();
    test_is_copy_assignable<enum_class>();
    test_is_copy_assignable<enum_struct>();
    ...
    //test_is_not_copy_assignable<IncompleteVariadicTemplate<class_type>>();
    //test_is_not_copy_assignable<IncompleteVariadicTemplate<incomplete_type>>();
    //test_is_not_copy_assignable<IncompleteVariadicTemplate<int, void, class_type, volatile char[]>>();
