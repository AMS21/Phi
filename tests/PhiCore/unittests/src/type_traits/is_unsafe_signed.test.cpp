...
TEST_CASE("is_unsafe_signed")
{
    ...
    test_is_not_unsafe_signed<ExplicitTo<class_type>>();
    ...
    test_is_not_unsafe_signed<public_static_tempalte_member<int>>();
    test_is_not_unsafe_signed<public_static_tempalte_member<float>>();
    test_is_not_unsafe_signed<public_static_tempalte_member<class_type>>();
    ...
    test_is_not_unsafe_signed<enum_type>();
    test_is_not_unsafe_signed<enum_signed>();
    test_is_not_unsafe_signed<enum_unsigned>();
    test_is_not_unsafe_signed<enum_class>();
    test_is_not_unsafe_signed<enum_struct>();
    ...
    test_is_not_unsafe_signed<IncompleteVariadicTemplate<class_type>>();
    test_is_not_unsafe_signed<IncompleteVariadicTemplate<incomplete_type>>();
    test_is_not_unsafe_signed<IncompleteVariadicTemplate<int, void, class_type, volatile char[]>>();
    test_is_not_unsafe_signed<incomplete_union>();
    test_is_not_unsafe_signed<incomplete_enum_signed>();
    test_is_not_unsafe_signed<incomplete_enum_unsigned>();
    test_is_not_unsafe_signed<incomplete_enum_class>();
    test_is_not_unsafe_signed<incomplete_enum_struct>();
