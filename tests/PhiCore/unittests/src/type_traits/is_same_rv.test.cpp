...
TEST_CASE("is_same_rv")
{
    ...
    test_is_same_rv<ExplicitTo<class_type>>();
    ...
    test_is_same_rv<enum_type>();
    test_is_same_rv<enum_signed>();
    test_is_same_rv<enum_unsigned>();
    test_is_same_rv<enum_class>();
    test_is_same_rv<enum_struct>();
    ...
    test_is_same_rv<IncompleteVariadicTemplate<class_type>>();
    test_is_same_rv<IncompleteVariadicTemplate<incomplete_type>>();
    test_is_same_rv<IncompleteVariadicTemplate<int, void, class_type, volatile char[]>>();
    test_is_same_rv<incomplete_union>();
    test_is_same_rv<incomplete_enum_signed>();
    test_is_same_rv<incomplete_enum_unsigned>();
    test_is_same_rv<incomplete_enum_class>();
    test_is_same_rv<incomplete_enum_struct>();
    test_is_same_rv<int class_type::*>();
    test_is_same_rv<float class_type::*>();
    test_is_same_rv<void * class_type::*>();
    test_is_same_rv<int * class_type::*>();
    test_is_same_rv<enum_type class_type::*>();
    ...
    test_is_same_rv_ref<int * class_type::*&>();
    test_is_same_rv_ref<enum_type class_type::*&>();
