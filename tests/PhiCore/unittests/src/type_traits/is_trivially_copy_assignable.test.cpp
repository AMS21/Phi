...
TEST_CASE("is_trivially_copy_assignable")
{
    ...
    test_is_trivially_copy_assignable<Template<incomplete_type>>();
    ...
    test_is_trivially_copy_assignable<VariadicTemplate<incomplete_type>>();
    test_is_trivially_copy_assignable<VariadicTemplate<int, void, Class, volatile char[]>>();
    test_is_trivially_copy_assignable<PublicDerviedFromTemplate<Base>>();
    test_is_trivially_copy_assignable<PublicDerviedFromTemplate<Derived>>();
    test_is_trivially_copy_assignable<PublicDerviedFromTemplate<Class>>();
    test_is_trivially_copy_assignable<PrivateDerviedFromTemplate<Base>>();
    test_is_trivially_copy_assignable<PrivateDerviedFromTemplate<Derived>>();
    test_is_trivially_copy_assignable<PrivateDerviedFromTemplate<Class>>();
    test_is_trivially_copy_assignable<ProtectedDerviedFromTemplate<Base>>();
    test_is_trivially_copy_assignable<ProtectedDerviedFromTemplate<Derived>>();
    test_is_trivially_copy_assignable<ProtectedDerviedFromTemplate<Class>>();
    ...
    test_is_not_trivially_copy_assignable<AbstractTemplate<incomplete_type>>();
