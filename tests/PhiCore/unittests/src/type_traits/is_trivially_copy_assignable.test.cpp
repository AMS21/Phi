...
void test_is_trivially_copy_assignable_impl()
{
    ...
    STATIC_REQUIRE_FALSE(phi::is_not_trivially_copy_assignable<T>::value);
    STATIC_REQUIRE(phi::is_copy_assignable<T>::value);

#    if PHI_HAS_FEATURE_VARIABLE_TEMPLATE()
    STATIC_REQUIRE(phi::is_trivially_copy_assignable_v<T>);
    STATIC_REQUIRE_FALSE(phi::is_not_trivially_copy_assignable_v<T>);
    STATIC_REQUIRE(phi::is_copy_assignable_v<T>);
#    endif

    TEST_TYPE_TRAITS_TYPE_DEFS(phi::is_trivially_copy_assignable<T>);
    TEST_TYPE_TRAITS_TYPE_DEFS(phi::is_not_trivially_copy_assignable<T>);

    // Standard compatibility
    STATIC_REQUIRE(std::is_trivially_copy_assignable<T>::value);
#endif
}
...
void test_is_not_trivially_copy_assignable_impl()
{
    ...
    STATIC_REQUIRE(phi::is_not_trivially_copy_assignable<T>::value);

#    if PHI_HAS_FEATURE_VARIABLE_TEMPLATE()
    STATIC_REQUIRE_FALSE(phi::is_trivially_copy_assignable_v<T>);
    STATIC_REQUIRE(phi::is_not_trivially_copy_assignable_v<T>);
#    endif
    ...
    STATIC_REQUIRE_FALSE(std::is_trivially_copy_assignable<T>::value);
#endif
}
...
{
    test_is_trivially_copy_assignable_impl<T>();
    test_is_not_trivially_copy_assignable_impl<const T>();
    test_is_not_trivially_copy_assignable_impl<volatile T>();
    test_is_not_trivially_copy_assignable_impl<const volatile T>();
}
...
void test_is_trivially_copy_assignable_v()
{
    test_is_trivially_copy_assignable_impl<T>();
    test_is_not_trivially_copy_assignable_impl<const T>();
    test_is_trivially_copy_assignable_impl<volatile T>();
    test_is_not_trivially_copy_assignable_impl<const volatile T>();
}
...
{
    test_is_trivially_copy_assignable_impl<T>();
    test_is_trivially_copy_assignable_impl<const T>();
    test_is_trivially_copy_assignable_impl<volatile T>();
    test_is_trivially_copy_assignable_impl<const volatile T>();
}

template <typename T>
void test_is_not_trivially_copy_assignable()
{
    test_is_not_trivially_copy_assignable_impl<T>();
    test_is_not_trivially_copy_assignable_impl<const T>();
    test_is_not_trivially_copy_assignable_impl<volatile T>();
    test_is_not_trivially_copy_assignable_impl<const volatile T>();
}
...
TEST_CASE("is_trivially_copy_assignable")
{
    ...
    test_is_not_trivially_copy_assignable<Class[]>();
    test_is_not_trivially_copy_assignable<Class[2]>();
    test_is_trivially_copy_assignable<Template<void>>();
    test_is_trivially_copy_assignable<Template<int>>();
    test_is_trivially_copy_assignable<Template<Class>>();
    test_is_trivially_copy_assignable<Template<IncompleteType>>();
    test_is_trivially_copy_assignable<VariadicTemplate<>>();
    test_is_trivially_copy_assignable<VariadicTemplate<void>>();
    test_is_trivially_copy_assignable<VariadicTemplate<int>>();
    test_is_trivially_copy_assignable<VariadicTemplate<Class>>();
    test_is_trivially_copy_assignable<VariadicTemplate<IncompleteType>>();
    test_is_trivially_copy_assignable<VariadicTemplate<int, void, Class, volatile char[]>>();
    test_is_trivially_copy_assignable<PublicDerivedFromTemplate<Base>>();
    test_is_trivially_copy_assignable<PublicDerivedFromTemplate<Derived>>();
    test_is_trivially_copy_assignable<PublicDerivedFromTemplate<Class>>();
    test_is_trivially_copy_assignable<PrivateDerivedFromTemplate<Base>>();
    test_is_trivially_copy_assignable<PrivateDerivedFromTemplate<Derived>>();
    test_is_trivially_copy_assignable<PrivateDerivedFromTemplate<Class>>();
    test_is_trivially_copy_assignable<ProtectedDerivedFromTemplate<Base>>();
    test_is_trivially_copy_assignable<ProtectedDerivedFromTemplate<Derived>>();
    test_is_trivially_copy_assignable<ProtectedDerivedFromTemplate<Class>>();
    ...
    test_is_trivially_copy_assignable<BitZero>();
    test_is_trivially_copy_assignable<BitOne>();
    ...
    test_is_not_trivially_copy_assignable<PublicAbstract>();
    test_is_not_trivially_copy_assignable<PrivateAbstract>();
    test_is_not_trivially_copy_assignable<ProtectedAbstract>();
    ...
    test_is_not_trivially_copy_assignable<AbstractTemplate<IncompleteType>>();
    test_is_trivially_copy_assignable<Final>();
    test_is_trivially_copy_assignable<PublicDestructor>();
    test_is_trivially_copy_assignable<ProtectedDestructor>();
    test_is_trivially_copy_assignable<PrivateDestructor>();
    test_is_not_trivially_copy_assignable<VirtualPublicDestructor>();
    test_is_not_trivially_copy_assignable<VirtualProtectedDestructor>();
    test_is_not_trivially_copy_assignable<VirtualPrivateDestructor>();
    test_is_not_trivially_copy_assignable<PurePublicDestructor>();
    test_is_not_trivially_copy_assignable<PureProtectedDestructor>();
    test_is_not_trivially_copy_assignable<PurePrivateDestructor>();
    test_is_trivially_copy_assignable<DeletedPublicDestructor>();
    test_is_trivially_copy_assignable<DeletedProtectedDestructor>();
    test_is_trivially_copy_assignable<DeletedPrivateDestructor>();
    test_is_not_trivially_copy_assignable<DeletedVirtualPublicDestructor>();
    test_is_not_trivially_copy_assignable<DeletedVirtualProtectedDestructor>();
    test_is_not_trivially_copy_assignable<DeletedVirtualPrivateDestructor>();
    ...
    test_is_trivially_copy_assignable_v<FunctionPtr>();
    test_is_trivially_copy_assignable_v<MemberObjectPtr>();
    test_is_trivially_copy_assignable_v<MemberFunctionPtr>();
    test_is_trivially_copy_assignable_v<int Class::*>();
    test_is_trivially_copy_assignable_v<float Class::*>();
    test_is_trivially_copy_assignable_v<void * Class::*>();
    test_is_trivially_copy_assignable_v<int * Class::*>();
    test_is_trivially_copy_assignable_cv<int Class::*&>();
    test_is_trivially_copy_assignable_cv<float Class::*&>();
    test_is_trivially_copy_assignable_cv<void * Class::*&>();
    test_is_trivially_copy_assignable_cv<int * Class::*&>();
    test_is_trivially_copy_assignable_cv<int Class::*&&>();
    test_is_trivially_copy_assignable_cv<float Class::*&&>();
    test_is_trivially_copy_assignable_cv<void * Class::*&&>();
    test_is_trivially_copy_assignable_cv<int * Class::*&&>();
    test_is_not_trivially_copy_assignable<int Class::*const>();
    test_is_not_trivially_copy_assignable<float Class::*const>();
    test_is_not_trivially_copy_assignable<void * Class::*const>();
    test_is_not_trivially_copy_assignable<int Class::*const&>();
    test_is_not_trivially_copy_assignable<float Class::*const&>();
    test_is_not_trivially_copy_assignable<void * Class::*const&>();
    test_is_not_trivially_copy_assignable<int Class::*const&&>();
    test_is_not_trivially_copy_assignable<float Class::*const&&>();
    test_is_not_trivially_copy_assignable<void * Class::*const&&>();
    test_is_trivially_copy_assignable_v<int Class::*volatile>();
    test_is_trivially_copy_assignable_v<float Class::*volatile>();
    test_is_trivially_copy_assignable_v<void * Class::*volatile>();
    test_is_trivially_copy_assignable_cv<int Class::*volatile&>();
    test_is_trivially_copy_assignable_cv<float Class::*volatile&>();
    test_is_trivially_copy_assignable_cv<void * Class::*volatile&>();
    test_is_trivially_copy_assignable_cv<int Class::*volatile&&>();
    test_is_trivially_copy_assignable_cv<float Class::*volatile&&>();
    test_is_trivially_copy_assignable_cv<void * Class::*volatile&&>();
    test_is_not_trivially_copy_assignable<int Class::*const volatile>();
    test_is_not_trivially_copy_assignable<float Class::*const volatile>();
    test_is_not_trivially_copy_assignable<void * Class::*const volatile>();
    test_is_not_trivially_copy_assignable<int Class::*const volatile&>();
    test_is_not_trivially_copy_assignable<float Class::*const volatile&>();
    test_is_not_trivially_copy_assignable<void * Class::*const volatile&>();
    test_is_not_trivially_copy_assignable<int Class::*const volatile&&>();
    test_is_not_trivially_copy_assignable<float Class::*const volatile&&>();
    test_is_not_trivially_copy_assignable<void * Class::*const volatile&&>();
    test_is_not_trivially_copy_assignable<NonCopyable>();
    test_is_trivially_copy_assignable<NonMoveable>();
    test_is_not_trivially_copy_assignable<NonConstructible>();
    test_is_not_trivially_copy_assignable<Tracked>();
    test_is_trivially_copy_assignable<TrapConstructible>();
    test_is_trivially_copy_assignable<TrapImplicitConversion>();
    test_is_trivially_copy_assignable<TrapComma>();
    test_is_trivially_copy_assignable<TrapCall>();
    test_is_not_trivially_copy_assignable<TrapSelfAssign>();
    test_is_trivially_copy_assignable<TrapDeref>();
    test_is_trivially_copy_assignable<TrapArraySubscript>();
    ...
    test_is_trivially_copy_assignable_v<void (Class::*)()&>();
    test_is_trivially_copy_assignable_v<void (Class::*)() &&>();
    test_is_trivially_copy_assignable_v<void (Class::*)() const>();
    test_is_trivially_copy_assignable_v<void (Class::*)() const&>();
    test_is_trivially_copy_assignable_v<void (Class::*)() const&&>();
    test_is_trivially_copy_assignable_v<void (Class::*)() noexcept>();
    test_is_trivially_copy_assignable_v<void (Class::*)()& noexcept>();
    test_is_trivially_copy_assignable_v<void (Class::*)()&& noexcept>();
    test_is_trivially_copy_assignable_v<void (Class::*)() const noexcept>();
    test_is_trivially_copy_assignable_v<void (Class::*)() const& noexcept>();
    test_is_trivially_copy_assignable_v<void (Class::*)() const&& noexcept>();

    test_is_trivially_copy_assignable_v<void (Class::*)(int)>();
    test_is_trivially_copy_assignable_v<void (Class::*)(int)&>();
    test_is_trivially_copy_assignable_v<void (Class::*)(int) &&>();
    test_is_trivially_copy_assignable_v<void (Class::*)(int) const>();
    test_is_trivially_copy_assignable_v<void (Class::*)(int) const&>();
    test_is_trivially_copy_assignable_v<void (Class::*)(int) const&&>();
    test_is_trivially_copy_assignable_v<void (Class::*)(int) noexcept>();
    test_is_trivially_copy_assignable_v<void (Class::*)(int)& noexcept>();
    test_is_trivially_copy_assignable_v<void (Class::*)(int)&& noexcept>();
    test_is_trivially_copy_assignable_v<void (Class::*)(int) const noexcept>();
    test_is_trivially_copy_assignable_v<void (Class::*)(int) const& noexcept>();
    test_is_trivially_copy_assignable_v<void (Class::*)(int) const&& noexcept>();
    ...
    test_is_trivially_copy_assignable_v<int (Class::*)()&>();
    test_is_trivially_copy_assignable_v<int (Class::*)() &&>();
    test_is_trivially_copy_assignable_v<int (Class::*)() const>();
    test_is_trivially_copy_assignable_v<int (Class::*)() const&>();
    test_is_trivially_copy_assignable_v<int (Class::*)() const&&>();
    test_is_trivially_copy_assignable_v<int (Class::*)() noexcept>();
    test_is_trivially_copy_assignable_v<int (Class::*)()& noexcept>();
    test_is_trivially_copy_assignable_v<int (Class::*)()&& noexcept>();
    test_is_trivially_copy_assignable_v<int (Class::*)() const noexcept>();
    test_is_trivially_copy_assignable_v<int (Class::*)() const& noexcept>();
    test_is_trivially_copy_assignable_v<int (Class::*)() const&& noexcept>();

    test_is_trivially_copy_assignable_v<int (Class::*)(int)>();
    test_is_trivially_copy_assignable_v<int (Class::*)(int)&>();
    test_is_trivially_copy_assignable_v<int (Class::*)(int) &&>();
    test_is_trivially_copy_assignable_v<int (Class::*)(int) const>();
    test_is_trivially_copy_assignable_v<int (Class::*)(int) const&>();
    test_is_trivially_copy_assignable_v<int (Class::*)(int) const&&>();
    test_is_trivially_copy_assignable_v<int (Class::*)(int) noexcept>();
    test_is_trivially_copy_assignable_v<int (Class::*)(int)& noexcept>();
    test_is_trivially_copy_assignable_v<int (Class::*)(int)&& noexcept>();
    test_is_trivially_copy_assignable_v<int (Class::*)(int) const noexcept>();
    test_is_trivially_copy_assignable_v<int (Class::*)(int) const& noexcept>();
    test_is_trivially_copy_assignable_v<int (Class::*)(int) const&& noexcept>();
