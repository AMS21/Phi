...
TEST_CASE("remove_reference")
{
    ...
    test_remove_reference<Template<IncompleteType>>();
    ...
    test_remove_reference<VariadicTemplate<IncompleteType>>();
    test_remove_reference<VariadicTemplate<int, void, Class, volatile char[]>>();
    test_remove_reference<PublicDerivedFromTemplate<Base>>();
    test_remove_reference<PublicDerivedFromTemplate<Derived>>();
    test_remove_reference<PublicDerivedFromTemplate<Class>>();
    test_remove_reference<PrivateDerivedFromTemplate<Base>>();
    test_remove_reference<PrivateDerivedFromTemplate<Derived>>();
    test_remove_reference<PrivateDerivedFromTemplate<Class>>();
    test_remove_reference<ProtectedDerivedFromTemplate<Base>>();
    test_remove_reference<ProtectedDerivedFromTemplate<Derived>>();
    test_remove_reference<ProtectedDerivedFromTemplate<Class>>();
    test_remove_reference<Union>();
    test_remove_reference<NonEmptyUnion>();
    test_remove_reference<Empty>();
    test_remove_reference<NotEmpty>();
    test_remove_reference<BitZero>();
    test_remove_reference<BitOne>();
    ...
    test_remove_reference<AbstractTemplate<IncompleteType>>();
    ...
    test_remove_reference<IncompleteType>();
    ...
    test_remove_reference<IncompleteTemplate<IncompleteType>>();
    ...
    test_remove_reference<IncompleteVariadicTemplate<IncompleteType>>();
