...
TEST_CASE("remove_reference")
{
    ...
    test_remove_reference<enum_type>();
    test_remove_reference<enum_signed>();
    test_remove_reference<enum_unsigned>();
    test_remove_reference<enum_class>();
    test_remove_reference<enum_struct>();
    ...
    test_remove_reference<IncompleteVariadicTemplate<class_type>>();
    test_remove_reference<IncompleteVariadicTemplate<incomplete_type>>();
    test_remove_reference<IncompleteVariadicTemplate<int, void, class_type, volatile char[]>>();
