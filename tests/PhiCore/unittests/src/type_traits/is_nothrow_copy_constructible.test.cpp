...
TEST_CASE("is_nothrow_copy_constructible")
{
    ...
    test_is_nothrow_copy_constructible<Template<IncompleteType>>();
    ...
    test_is_nothrow_copy_constructible<VariadicTemplate<IncompleteType>>();
    test_is_nothrow_copy_constructible<VariadicTemplate<int, void, Class, volatile char[]>>();
    test_is_nothrow_copy_constructible<PublicDerivedFromTemplate<Base>>();
    test_is_nothrow_copy_constructible<PublicDerivedFromTemplate<Derived>>();
    test_is_nothrow_copy_constructible<PublicDerivedFromTemplate<Class>>();
    test_is_nothrow_copy_constructible<PrivateDerivedFromTemplate<Base>>();
    test_is_nothrow_copy_constructible<PrivateDerivedFromTemplate<Derived>>();
    test_is_nothrow_copy_constructible<PrivateDerivedFromTemplate<Class>>();
    test_is_nothrow_copy_constructible<ProtectedDerivedFromTemplate<Base>>();
    test_is_nothrow_copy_constructible<ProtectedDerivedFromTemplate<Derived>>();
    test_is_nothrow_copy_constructible<ProtectedDerivedFromTemplate<Class>>();
    ...
    test_is_nothrow_copy_constructible<BitZero>();
    ...
    test_is_not_nothrow_copy_constructible<AbstractTemplate<IncompleteType>>();
#endif
