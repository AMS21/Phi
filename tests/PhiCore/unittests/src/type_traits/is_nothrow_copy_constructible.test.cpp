...
TEST_CASE("is_nothrow_copy_constructible")
{
    ...
    test_is_nothrow_copy_constructible<enum_type>();
    test_is_nothrow_copy_constructible<enum_signed>();
    test_is_nothrow_copy_constructible<enum_unsigned>();
    test_is_nothrow_copy_constructible<enum_class>();
    test_is_nothrow_copy_constructible<enum_struct>();
