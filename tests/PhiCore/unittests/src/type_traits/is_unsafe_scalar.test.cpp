...
TEST_CASE("is_unsafe_scalar")
{
    ...
    test_is_not_unsafe_scalar<ExplicitTo<class_type>>();
    ...
    test_is_unsafe_scalar<enum_type>();
    test_is_unsafe_scalar<enum_signed>();
    test_is_unsafe_scalar<enum_unsigned>();
    test_is_unsafe_scalar<enum_class>();
    test_is_unsafe_scalar<enum_struct>();
    ...
    test_is_not_unsafe_scalar<IncompleteVariadicTemplate<class_type>>();
    test_is_not_unsafe_scalar<IncompleteVariadicTemplate<incomplete_type>>();
    test_is_not_unsafe_scalar<IncompleteVariadicTemplate<int, void, class_type, volatile char[]>>();
    test_is_not_unsafe_scalar<incomplete_union>();
    test_is_unsafe_scalar<incomplete_enum_signed>();
    test_is_unsafe_scalar<incomplete_enum_unsigned>();
    test_is_unsafe_scalar<incomplete_enum_class>();
    test_is_unsafe_scalar<incomplete_enum_struct>();
