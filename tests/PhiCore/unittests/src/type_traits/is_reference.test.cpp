...
void test_is_reference_impl()
{
    ...
    STATIC_REQUIRE_FALSE(phi::is_not_reference<TypeT>::value);
    STATIC_REQUIRE(phi::is_lvalue_reference<TypeT>::value ||
                   phi::is_rvalue_reference<TypeT>::value);
    ...
    STATIC_REQUIRE_FALSE(phi::is_not_reference_v<TypeT>);
    STATIC_REQUIRE(phi::is_lvalue_reference_v<TypeT> || phi::is_rvalue_reference_v<TypeT>);
...
#    endif
    ...
    TEST_TYPE_TRAITS_TYPE_DEFS(phi::is_reference<TypeT>);
    TEST_TYPE_TRAITS_TYPE_DEFS(phi::is_not_reference<TypeT>);

    // Standard compatibility
    STATIC_REQUIRE(std::is_reference<TypeT>::value);
}
...
void test_is_not_reference_impl()
{
    ...
    STATIC_REQUIRE(phi::is_not_reference<TypeT>::value);
    STATIC_REQUIRE_FALSE(phi::is_lvalue_reference<TypeT>::value ||
                         phi::is_rvalue_reference<TypeT>::value);

#if PHI_HAS_FEATURE_VARIABLE_TEMPLATE()
    STATIC_REQUIRE_FALSE(phi::is_reference_v<TypeT>);
    STATIC_REQUIRE(phi::is_not_reference_v<TypeT>);
    STATIC_REQUIRE_FALSE(phi::is_lvalue_reference_v<TypeT> || phi::is_rvalue_reference_v<TypeT>);
#endif
    ...
    // Standard compatibility
    STATIC_REQUIRE_FALSE(std::is_reference<TypeT>::value);
}

template <typename TypeT>
void test_is_reference()
{
    test_is_reference_impl<TypeT>();
    test_is_reference_impl<const TypeT>();
    test_is_reference_impl<volatile TypeT>();
    test_is_reference_impl<const volatile TypeT>();
}

template <typename TypeT>
void test_is_not_reference()
{
    test_is_not_reference_impl<TypeT>();
    test_is_not_reference_impl<const TypeT>();
    test_is_not_reference_impl<volatile TypeT>();
    test_is_not_reference_impl<const volatile TypeT>();
}
...
TEST_CASE("is_reference")
{
    ...
    test_is_not_reference<incomplete_variadic_template<>>();
    test_is_not_reference<incomplete_variadic_template<void>>();
    test_is_not_reference<incomplete_variadic_template<int>>();
    test_is_not_reference<incomplete_variadic_template<class_type>>();
    test_is_not_reference<incomplete_variadic_template<incomplete_type>>();
    test_is_not_reference<incomplete_variadic_template<int, void, class_type, volatile char[]>>();
