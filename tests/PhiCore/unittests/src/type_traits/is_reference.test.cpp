...
TEST_CASE("is_reference")
{
    ...
    test_is_not_reference<Template<incomplete_type>>();
    ...
    test_is_not_reference<VariadicTemplate<incomplete_type>>();
    test_is_not_reference<VariadicTemplate<int, void, Class, volatile char[]>>();
    test_is_not_reference<PublicDerviedFromTemplate<Base>>();
    test_is_not_reference<PublicDerviedFromTemplate<Derived>>();
    test_is_not_reference<PublicDerviedFromTemplate<Class>>();
    test_is_not_reference<PrivateDerviedFromTemplate<Base>>();
    test_is_not_reference<PrivateDerviedFromTemplate<Derived>>();
    test_is_not_reference<PrivateDerviedFromTemplate<Class>>();
    test_is_not_reference<ProtectedDerviedFromTemplate<Base>>();
    test_is_not_reference<ProtectedDerviedFromTemplate<Derived>>();
    test_is_not_reference<ProtectedDerviedFromTemplate<Class>>();
    ...
    test_is_not_reference<AbstractTemplate<incomplete_type>>();
    ...
    test_is_not_reference<IncompleteTemplate<incomplete_type>>();
