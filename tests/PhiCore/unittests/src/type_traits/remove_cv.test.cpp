...
TEST_CASE("remove_cv")
{
    ...
    test_remove_cv<enum_type>();
    test_remove_cv<enum_signed>();
    test_remove_cv<enum_unsigned>();
    test_remove_cv<enum_class>();
    test_remove_cv<enum_struct>();
    ...
    test_remove_cv<IncompleteVariadicTemplate<class_type>>();
    test_remove_cv<IncompleteVariadicTemplate<incomplete_type>>();
    test_remove_cv<IncompleteVariadicTemplate<int, void, class_type, volatile char[]>>();
