...
TEST_CASE("remove_cv")
{
    ...
    test_remove_cv<Template<IncompleteType>>();
    ...
    test_remove_cv<VariadicTemplate<IncompleteType>>();
    test_remove_cv<VariadicTemplate<int, void, Class, volatile char[]>>();
    test_remove_cv<PublicDerivedFromTemplate<Base>>();
    test_remove_cv<PublicDerivedFromTemplate<Derived>>();
    test_remove_cv<PublicDerivedFromTemplate<Class>>();
    test_remove_cv<PrivateDerivedFromTemplate<Base>>();
    test_remove_cv<PrivateDerivedFromTemplate<Derived>>();
    test_remove_cv<PrivateDerivedFromTemplate<Class>>();
    test_remove_cv<ProtectedDerivedFromTemplate<Base>>();
    test_remove_cv<ProtectedDerivedFromTemplate<Derived>>();
    test_remove_cv<ProtectedDerivedFromTemplate<Class>>();
    test_remove_cv<Union>();
    test_remove_cv<NonEmptyUnion>();
    test_remove_cv<Empty>();
    test_remove_cv<NotEmpty>();
    test_remove_cv<BitZero>();
    test_remove_cv<BitOne>();
    test_remove_cv<Base>();
    ...
    test_remove_cv<AbstractTemplate<IncompleteType>>();
    ...
    test_remove_cv<IncompleteVariadicTemplate<IncompleteType>>();
