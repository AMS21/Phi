...
TEST_CASE("add_pointer")
{
    ...
    test_add_pointer<enum_type>();
    test_add_pointer<enum_signed>();
    test_add_pointer<enum_unsigned>();
    test_add_pointer<enum_class>();
    test_add_pointer<enum_struct>();
    ...
    test_add_pointer<IncompleteVariadicTemplate<class_type>>();
    test_add_pointer<IncompleteVariadicTemplate<incomplete_type>>();
    test_add_pointer<IncompleteVariadicTemplate<int, void, class_type, volatile char[]>>();
