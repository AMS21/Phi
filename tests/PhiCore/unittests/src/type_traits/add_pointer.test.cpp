...
TEST_CASE("add_pointer")
{
    ...
    test_add_pointer<Template<IncompleteType>>();
    ...
    test_add_pointer<VariadicTemplate<IncompleteType>>();
    test_add_pointer<VariadicTemplate<int, void, Class, volatile char[]>>();
    test_add_pointer<PublicDerivedFromTemplate<Base>>();
    test_add_pointer<PublicDerivedFromTemplate<Derived>>();
    test_add_pointer<PublicDerivedFromTemplate<Class>>();
    test_add_pointer<PrivateDerivedFromTemplate<Base>>();
    test_add_pointer<PrivateDerivedFromTemplate<Derived>>();
    test_add_pointer<PrivateDerivedFromTemplate<Class>>();
    test_add_pointer<ProtectedDerivedFromTemplate<Base>>();
    test_add_pointer<ProtectedDerivedFromTemplate<Derived>>();
    test_add_pointer<ProtectedDerivedFromTemplate<Class>>();
    test_add_pointer<Union>();
    test_add_pointer<NonEmptyUnion>();
    test_add_pointer<Empty>();
    test_add_pointer<NotEmpty>();
    test_add_pointer<BitZero>();
    test_add_pointer<BitOne>();
    ...
    test_add_pointer<AbstractTemplate<IncompleteType>>();
    ...
    test_add_pointer<IncompleteVariadicTemplate<IncompleteType>>();
