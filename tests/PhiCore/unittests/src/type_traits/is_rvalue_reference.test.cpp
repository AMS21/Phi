...
TEST_CASE("is_rvalue_reference")
{
    ...
    test_is_not_rvalue_reference<Template<incomplete_type>>();
    ...
    test_is_not_rvalue_reference<VariadicTemplate<incomplete_type>>();
    test_is_not_rvalue_reference<VariadicTemplate<int, void, Class, volatile char[]>>();
    test_is_not_rvalue_reference<PublicDerviedFromTemplate<Base>>();
    test_is_not_rvalue_reference<PublicDerviedFromTemplate<Derived>>();
    test_is_not_rvalue_reference<PublicDerviedFromTemplate<Class>>();
    test_is_not_rvalue_reference<PrivateDerviedFromTemplate<Base>>();
    test_is_not_rvalue_reference<PrivateDerviedFromTemplate<Derived>>();
    test_is_not_rvalue_reference<PrivateDerviedFromTemplate<Class>>();
    test_is_not_rvalue_reference<ProtectedDerviedFromTemplate<Base>>();
    test_is_not_rvalue_reference<ProtectedDerviedFromTemplate<Derived>>();
    test_is_not_rvalue_reference<ProtectedDerviedFromTemplate<Class>>();
    ...
    test_is_not_rvalue_reference<IncompleteTemplate<incomplete_type>>();
