...
TEST_CASE("is_void")
{
    ...
    test_is_not_void<ExplicitTo<class_type>>();
    ...
    test_is_not_void<enum_type>();
    test_is_not_void<enum_signed>();
    test_is_not_void<enum_unsigned>();
    test_is_not_void<enum_class>();
    test_is_not_void<enum_struct>();
    ...
    test_is_not_void<IncompleteVariadicTemplate<class_type>>();
    test_is_not_void<IncompleteVariadicTemplate<incomplete_type>>();
    test_is_not_void<IncompleteVariadicTemplate<int, void, class_type, volatile char[]>>();
    test_is_not_void<incomplete_union>();
    test_is_not_void<incomplete_enum_signed>();
    test_is_not_void<incomplete_enum_unsigned>();
    test_is_not_void<incomplete_enum_class>();
    test_is_not_void<incomplete_enum_struct>();
    test_is_not_void<int class_type::*>();
    test_is_not_void<float class_type::*>();
    test_is_not_void<void * class_type::*>();
    test_is_not_void<int * class_type::*>();
    test_is_not_void<enum_type class_type::*>();
