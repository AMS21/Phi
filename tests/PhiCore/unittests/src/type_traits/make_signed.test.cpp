...
TEST_CASE("make_signed")
{
    ...
    test_make_signed<Template<IncompleteType>>();
    ...
    test_make_signed<VariadicTemplate<IncompleteType>>();
    test_make_signed<VariadicTemplate<int, void, Class, volatile char[]>>();
    test_make_signed<PublicDerivedFromTemplate<Base>>();
    test_make_signed<PublicDerivedFromTemplate<Derived>>();
    test_make_signed<PublicDerivedFromTemplate<Class>>();
    test_make_signed<PrivateDerivedFromTemplate<Base>>();
    test_make_signed<PrivateDerivedFromTemplate<Derived>>();
    test_make_signed<PrivateDerivedFromTemplate<Class>>();
    test_make_signed<ProtectedDerivedFromTemplate<Base>>();
    test_make_signed<ProtectedDerivedFromTemplate<Derived>>();
    test_make_signed<ProtectedDerivedFromTemplate<Class>>();
    test_make_signed<Union>();
    test_make_signed<NonEmptyUnion>();
    test_make_signed<Empty>();
    test_make_signed<NotEmpty>();
    test_make_signed<BitZero>();
    test_make_signed<BitOne>();
    ...
    test_make_signed<AbstractTemplate<IncompleteType>>();
    ...
    test_make_signed<IncompleteVariadicTemplate<IncompleteType>>();
