...
TEST_CASE("is_compound")
{
    ...
    test_is_compound<enum_type>();
    test_is_compound<enum_signed>();
    test_is_compound<enum_unsigned>();
    test_is_compound<enum_class>();
    test_is_compound<enum_struct>();
    ...
    test_is_compound<IncompleteVariadicTemplate<class_type>>();
    test_is_compound<IncompleteVariadicTemplate<incomplete_type>>();
    test_is_compound<IncompleteVariadicTemplate<int, void, class_type, volatile char[]>>();
