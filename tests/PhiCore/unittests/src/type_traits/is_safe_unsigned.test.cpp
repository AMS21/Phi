...
{
    STATIC_REQUIRE(phi::is_safe_unsigned<TypeT>::value);
    STATIC_REQUIRE_FALSE(phi::is_not_safe_unsigned<TypeT>::value);

#if PHI_HAS_FEATURE_VARIABLE_TEMPLATE()
    STATIC_REQUIRE(phi::is_safe_unsigned_v<TypeT>);
    STATIC_REQUIRE_FALSE(phi::is_not_safe_unsigned_v<TypeT>);
#endif

    TEST_TYPE_TRAITS_TYPE_DEFS(phi::is_safe_unsigned<TypeT>);
    TEST_TYPE_TRAITS_TYPE_DEFS(phi::is_not_safe_unsigned<TypeT>);
}

template <typename TypeT>
void test_is_not_safe_unsigned_impl()
{
    STATIC_REQUIRE_FALSE(phi::is_safe_unsigned<TypeT>::value);
    STATIC_REQUIRE(phi::is_not_safe_unsigned<TypeT>::value);

#if PHI_HAS_FEATURE_VARIABLE_TEMPLATE()
    STATIC_REQUIRE_FALSE(phi::is_safe_unsigned_v<TypeT>);
    STATIC_REQUIRE(phi::is_not_safe_unsigned_v<TypeT>);
#endif
...
{
    test_is_safe_unsigned_impl<TypeT>();
    test_is_safe_unsigned_impl<const TypeT>();
    test_is_safe_unsigned_impl<volatile TypeT>();
    test_is_safe_unsigned_impl<const volatile TypeT>();
}

template <typename TypeT>
void test_is_not_safe_unsigned()
{
    test_is_not_safe_unsigned_impl<TypeT>();
    test_is_not_safe_unsigned_impl<const TypeT>();
    test_is_not_safe_unsigned_impl<volatile TypeT>();
    test_is_not_safe_unsigned_impl<const volatile TypeT>();
}
...
TEST_CASE("is_safe_unsigned")
{
    ...
    test_is_not_safe_unsigned<explicit_to<int>>();
    test_is_not_safe_unsigned<explicit_to<float>>();
    test_is_not_safe_unsigned<explicit_to<class_type>>();
    ...
    test_is_not_safe_unsigned<incomplete_variadic_template<>>();
    test_is_not_safe_unsigned<incomplete_variadic_template<void>>();
    test_is_not_safe_unsigned<incomplete_variadic_template<int>>();
    test_is_not_safe_unsigned<incomplete_variadic_template<class_type>>();
    test_is_not_safe_unsigned<incomplete_variadic_template<incomplete_type>>();
    test_is_not_safe_unsigned<
