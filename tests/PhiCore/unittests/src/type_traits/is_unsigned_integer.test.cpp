...
TEST_CASE("is_unsigned_integer")
{
    ...
    test_is_not_unsigned_integer<ExplicitTo<class_type>>();
    ...
    test_is_not_unsigned_integer<public_static_tempalte_member<int>>();
    test_is_not_unsigned_integer<public_static_tempalte_member<float>>();
    test_is_not_unsigned_integer<public_static_tempalte_member<class_type>>();
    ...
    test_is_not_unsigned_integer<enum_type>();
    test_is_not_unsigned_integer<enum_signed>();
    test_is_not_unsigned_integer<enum_unsigned>();
    test_is_not_unsigned_integer<enum_class>();
    test_is_not_unsigned_integer<enum_struct>();
    ...
    test_is_not_unsigned_integer<IncompleteVariadicTemplate<class_type>>();
    test_is_not_unsigned_integer<IncompleteVariadicTemplate<incomplete_type>>();
    ...
    test_is_not_unsigned_integer<incomplete_enum_signed>();
    test_is_not_unsigned_integer<incomplete_enum_unsigned>();
    test_is_not_unsigned_integer<incomplete_enum_class>();
    test_is_not_unsigned_integer<incomplete_enum_struct>();
