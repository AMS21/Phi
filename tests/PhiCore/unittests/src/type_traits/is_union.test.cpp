...
TEST_CASE("is_union")
{
    ...
    test_is_not_union<final_type>();
    test_is_not_union<enum_type>();
    test_is_not_union<enum_signed>();
    test_is_not_union<enum_unsigned>();
    test_is_not_union<enum_class>();
    test_is_not_union<enum_struct>();
    ...
    test_is_not_union<IncompleteVariadicTemplate<class_type>>();
    test_is_not_union<IncompleteVariadicTemplate<incomplete_type>>();
    test_is_not_union<IncompleteVariadicTemplate<int, void, class_type, volatile char[]>>();
