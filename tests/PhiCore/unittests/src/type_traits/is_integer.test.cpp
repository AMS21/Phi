...
TEST_CASE("is_integer")
{
    ...
    test_is_not_integer<Template<incomplete_type>>();
    ...
    test_is_not_integer<VariadicTemplate<incomplete_type>>();
    test_is_not_integer<VariadicTemplate<int, void, Class, volatile char[]>>();
    test_is_not_integer<PublicDerviedFromTemplate<Base>>();
    test_is_not_integer<PublicDerviedFromTemplate<Derived>>();
    test_is_not_integer<PublicDerviedFromTemplate<Class>>();
    test_is_not_integer<PrivateDerviedFromTemplate<Base>>();
    test_is_not_integer<PrivateDerviedFromTemplate<Derived>>();
    test_is_not_integer<PrivateDerviedFromTemplate<Class>>();
    test_is_not_integer<ProtectedDerviedFromTemplate<Base>>();
    test_is_not_integer<ProtectedDerviedFromTemplate<Derived>>();
    test_is_not_integer<ProtectedDerviedFromTemplate<Class>>();
    ...
    test_is_not_integer<AbstractTemplate<incomplete_type>>();
    ...
    test_is_not_integer<IncompleteTemplate<incomplete_type>>();
