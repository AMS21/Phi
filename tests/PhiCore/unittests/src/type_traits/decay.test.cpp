...
TEST_CASE("decay")
{
    ...
    test_decay<enum_type>();
    test_decay<enum_signed>();
    test_decay<enum_unsigned>();
    test_decay<enum_class>();
    test_decay<enum_struct>();
    ...
    test_decay<IncompleteVariadicTemplate<class_type>>();
    test_decay<IncompleteVariadicTemplate<incomplete_type>>();
    test_decay<IncompleteVariadicTemplate<int, void, class_type, volatile char[]>>();
