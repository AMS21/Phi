...
TEST_CASE("is_const")
{
    ...
    test_is_const<enum_type>();
    test_is_const<enum_signed>();
    test_is_const<enum_unsigned>();
    test_is_const<enum_class>();
    test_is_const<enum_struct>();
    ...
    test_is_const<IncompleteVariadicTemplate<class_type>>();
    test_is_const<IncompleteVariadicTemplate<incomplete_type>>();
    test_is_const<IncompleteVariadicTemplate<int, void, class_type, volatile char[]>>();
