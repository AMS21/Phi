...
TEST_CASE("is_const")
{
    ...
    test_is_const<Template<IncompleteType>>();
    ...
    test_is_const<VariadicTemplate<IncompleteType>>();
    test_is_const<VariadicTemplate<int, void, Class, volatile char[]>>();
    test_is_const<PublicDerivedFromTemplate<Base>>();
    test_is_const<PublicDerivedFromTemplate<Derived>>();
    test_is_const<PublicDerivedFromTemplate<Class>>();
    test_is_const<PrivateDerivedFromTemplate<Base>>();
    test_is_const<PrivateDerivedFromTemplate<Derived>>();
    test_is_const<PrivateDerivedFromTemplate<Class>>();
    test_is_const<ProtectedDerivedFromTemplate<Base>>();
    test_is_const<ProtectedDerivedFromTemplate<Derived>>();
    test_is_const<ProtectedDerivedFromTemplate<Class>>();
    test_is_const<Union>();
    test_is_const<NonEmptyUnion>();
    test_is_const<Empty>();
    test_is_const<NotEmpty>();
    test_is_const<BitZero>();
    test_is_const<BitOne>();
    test_is_const<Base>();
    ...
    test_is_const<AbstractTemplate<IncompleteType>>();
    test_is_const<Final>();
    ...
    test_is_const<IncompleteVariadicTemplate<IncompleteType>>();
