...
TEST_CASE("is_bounded_array")
{
    ...
    test_is_not_bounded_array<enum_type>();
    test_is_not_bounded_array<enum_signed>();
    test_is_not_bounded_array<enum_unsigned>();
    test_is_not_bounded_array<enum_class>();
    test_is_not_bounded_array<enum_struct>();
    ...
    test_is_not_bounded_array<IncompleteVariadicTemplate<class_type>>();
    test_is_not_bounded_array<IncompleteVariadicTemplate<incomplete_type>>();
    test_is_not_bounded_array<IncompleteVariadicTemplate<int, void, class_type, volatile char[]>>();
