...
TEST_CASE("is_bool")
{
    ...
    test_is_not_bool<phi::FloatingPoint<float>>();
    test_is_not_bool<phi::FloatingPoint<double>>();
    test_is_not_bool<phi::FloatingPoint<long double>>();

    test_is_not_bool<std::vector<int>>();
    test_is_not_bool<phi::ScopePtr<int>>();
    ...
    test_is_not_bool<Template<incomplete_type>>();
    ...
    test_is_not_bool<VariadicTemplate<incomplete_type>>();
    test_is_not_bool<VariadicTemplate<int, void, Class, volatile char[]>>();
    test_is_not_bool<PublicDerviedFromTemplate<Base>>();
    test_is_not_bool<PublicDerviedFromTemplate<Derived>>();
    test_is_not_bool<PublicDerviedFromTemplate<Class>>();
    test_is_not_bool<PrivateDerviedFromTemplate<Base>>();
    test_is_not_bool<PrivateDerviedFromTemplate<Derived>>();
    test_is_not_bool<PrivateDerviedFromTemplate<Class>>();
    test_is_not_bool<ProtectedDerviedFromTemplate<Base>>();
    test_is_not_bool<ProtectedDerviedFromTemplate<Derived>>();
    test_is_not_bool<ProtectedDerviedFromTemplate<Class>>();
    ...
    test_is_not_bool<AbstractTemplate<incomplete_type>>();
    ...
    test_is_not_bool<IncompleteTemplate<incomplete_type>>();
