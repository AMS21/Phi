...
TEST_CASE("is_bounded_array")
{
    ...
    test_is_not_bounded_array<phi::FloatingPoint<float>>();
    test_is_not_bounded_array<phi::FloatingPoint<double>>();
    test_is_not_bounded_array<phi::FloatingPoint<long double>>();

    test_is_not_bounded_array<std::vector<int>>();
    test_is_not_bounded_array<phi::ScopePtr<int>>();
