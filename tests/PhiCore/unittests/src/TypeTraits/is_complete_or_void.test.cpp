...
#include <Phi/TypeTraits/is_complete_or_void.hpp>
#include <type_traits>
#include <vector>
...
TEST_CASE("is_complete_or_void")
{
    ...
    test_is_complete_or_void<phi::FloatingPoint<float>>();
    test_is_complete_or_void<phi::FloatingPoint<double>>();
    test_is_complete_or_void<phi::FloatingPoint<long double>>();

    test_is_complete_or_void<std::vector<int>>();
    test_is_complete_or_void<phi::ScopePtr<int>>();
