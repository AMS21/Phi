...
TEST_CASE("is_abstract")
{
    ...
    test_is_not_abstract<phi::FloatingPoint<float>>();
    test_is_not_abstract<phi::FloatingPoint<double>>();
    test_is_not_abstract<phi::FloatingPoint<long double>>();

    test_is_not_abstract<std::vector<int>>();
    test_is_not_abstract<phi::ScopePtr<int>>();
