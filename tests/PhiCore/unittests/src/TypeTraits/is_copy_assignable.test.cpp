...
TEST_CASE("is_copy_assignable")
{
    ...
    test_is_copy_assignable<phi::FloatingPoint<float>>();
    test_is_copy_assignable<phi::FloatingPoint<double>>();
    test_is_copy_assignable<phi::FloatingPoint<long double>>();

    test_is_copy_assignable<std::vector<int>>();
    test_is_not_copy_assignable<phi::ScopePtr<int>>();
