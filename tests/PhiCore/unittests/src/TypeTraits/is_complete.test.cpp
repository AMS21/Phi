...
TEST_CASE("is_complete")
{
    ...
    test_is_complete<phi::FloatingPoint<float>>();
    test_is_complete<phi::FloatingPoint<double>>();
    test_is_complete<phi::FloatingPoint<long double>>();

    test_is_complete<std::vector<int>>();
    test_is_complete<phi::ScopePtr<int>>();
    ...
    test_is_complete<Template<incomplete_type>>();
    ...
    test_is_complete<VariadicTemplate<incomplete_type>>();
    test_is_complete<VariadicTemplate<int, void, Class, volatile char[]>>();
    test_is_complete<PublicDerviedFromTemplate<Base>>();
    test_is_complete<PublicDerviedFromTemplate<Derived>>();
    test_is_complete<PublicDerviedFromTemplate<Class>>();
    test_is_complete<PrivateDerviedFromTemplate<Base>>();
    test_is_complete<PrivateDerviedFromTemplate<Derived>>();
    test_is_complete<PrivateDerviedFromTemplate<Class>>();
    test_is_complete<ProtectedDerviedFromTemplate<Base>>();
    test_is_complete<ProtectedDerviedFromTemplate<Derived>>();
    test_is_complete<ProtectedDerviedFromTemplate<Class>>();
    ...
    test_is_complete<AbstractTemplate<incomplete_type>>();
    ...
    test_is_not_complete<IncompleteTemplate<incomplete_type>>();
    ...
    test_is_not_complete<IncompleteVariadicTemplate<incomplete_type>>();
