...
TEST_CASE("is_aggregate")
{
    ...
    test_is_not_aggregate<phi::FloatingPoint<float>>();
    test_is_not_aggregate<phi::FloatingPoint<double>>();
    test_is_not_aggregate<phi::FloatingPoint<long double>>();

    test_is_not_aggregate<std::vector<int>>();
    test_is_not_aggregate<phi::ScopePtr<int>>();
