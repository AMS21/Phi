...
TEST_CASE("add_rvalue_reference")
{
    ...
    test_add_rvalue_reference<phi::FloatingPoint<float>>();
    test_add_rvalue_reference<phi::FloatingPoint<double>>();
    test_add_rvalue_reference<phi::FloatingPoint<long double>>();

    test_add_rvalue_reference<std::vector<int>>();
    test_add_rvalue_reference<phi::ScopePtr<int>>();
