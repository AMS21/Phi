...
template <typename TypeT>
PHI_INLINE_VARIABLE PHI_CONSTEXPR bool is_reference_v = PHI_IS_REFERENCE(TypeT);

template <typename TypeT>
PHI_INLINE_VARIABLE PHI_CONSTEXPR bool is_not_reference_v = !PHI_IS_REFERENCE(TypeT);
...
template <typename TypeT>
PHI_INLINE_VARIABLE PHI_CONSTEXPR bool is_reference_v = is_reference<TypeT>::value;

template <typename TypeT>
PHI_INLINE_VARIABLE PHI_CONSTEXPR bool is_not_reference_v = is_not_reference<TypeT>::value;
