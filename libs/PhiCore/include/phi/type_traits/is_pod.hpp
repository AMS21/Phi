...
template <typename TypeT>
PHI_INLINE_VARIABLE constexpr bool is_pod_v = PHI_IS_POD(TypeT);

template <typename TypeT>
PHI_INLINE_VARIABLE constexpr bool is_not_pod_v = !PHI_IS_POD(TypeT);
...
template <typename TypeT>
PHI_INLINE_VARIABLE constexpr bool is_pod_v = is_pod<TypeT>::value;

template <typename TypeT>
PHI_INLINE_VARIABLE constexpr bool is_not_pod_v = is_not_pod<TypeT>::value;
