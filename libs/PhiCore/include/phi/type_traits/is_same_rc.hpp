...
template <typename LhsT, typename RhsT>
PHI_INLINE_VARIABLE PHI_CONSTEXPR bool is_same_rc_v = is_same_rc<LhsT, RhsT>::value;

template <typename LhsT, typename RhsT>
PHI_INLINE_VARIABLE PHI_CONSTEXPR bool is_not_same_rc_v = is_not_same_rc<LhsT, RhsT>::value;
