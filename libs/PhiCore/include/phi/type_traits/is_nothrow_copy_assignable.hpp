...
struct is_not_nothrow_copy_assignable
    : public integral_constant<bool, !is_nothrow_copy_assignable<TypeT>::value>
{};

#if PHI_HAS_FEATURE_VARIABLE_TEMPLATE()

template <typename TypeT>
PHI_INLINE_VARIABLE PHI_CONSTEXPR bool is_nothrow_copy_assignable_v =
        is_nothrow_copy_assignable<TypeT>::value;

template <typename TypeT>
PHI_INLINE_VARIABLE PHI_CONSTEXPR bool is_not_nothrow_copy_assignable_v =
