...
template <typename TypeT>
struct is_not_safe_floating_point
...
template <typename TypeT>
PHI_INLINE_VARIABLE PHI_CONSTEXPR bool is_safe_floating_point_v =
        is_safe_floating_point<TypeT>::value;

template <typename TypeT>
PHI_INLINE_VARIABLE PHI_CONSTEXPR bool is_not_safe_floating_point_v =
