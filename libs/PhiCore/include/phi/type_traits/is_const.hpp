...
template <typename TypeT>
PHI_INLINE_VARIABLE PHI_CONSTEXPR bool is_const_v = PHI_IS_CONST(TypeT);

template <typename TypeT>
PHI_INLINE_VARIABLE PHI_CONSTEXPR bool is_not_const_v = !PHI_IS_CONST(TypeT);
...
template <typename TypeT>
PHI_INLINE_VARIABLE PHI_CONSTEXPR bool is_const_v = is_const<TypeT>::value;

template <typename TypeT>
PHI_INLINE_VARIABLE PHI_CONSTEXPR bool is_not_const_v = is_not_const<TypeT>::value;
