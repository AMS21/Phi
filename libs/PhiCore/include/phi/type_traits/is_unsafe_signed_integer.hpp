...
struct is_unsafe_signed_integer
    : public integral_constant<bool,
                               is_unsafe_integer<TypeT>::value && is_unsafe_signed<TypeT>::value>
{};

template <typename TypeT>
struct is_not_unsafe_signed_integer
    : public integral_constant<bool, !is_unsafe_signed_integer<TypeT>::value>
{};

#if PHI_HAS_FEATURE_VARIABLE_TEMPLATE()

template <typename TypeT>
PHI_INLINE_VARIABLE PHI_CONSTEXPR bool is_unsafe_signed_integer_v =
        is_unsafe_signed_integer<TypeT>::value;

template <typename TypeT>
PHI_INLINE_VARIABLE PHI_CONSTEXPR bool is_not_unsafe_signed_integer_v =
