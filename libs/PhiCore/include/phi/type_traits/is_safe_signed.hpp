...
template <typename TypeT>
PHI_INLINE_VARIABLE PHI_CONSTEXPR bool is_safe_signed_v = is_safe_signed<TypeT>::value;

template <typename TypeT>
PHI_INLINE_VARIABLE PHI_CONSTEXPR bool is_not_safe_signed_v = is_not_safe_signed<TypeT>::value;
