...
template <typename TypeT>
PHI_INLINE_VARIABLE PHI_CONSTEXPR bool is_unsigned_integer_v = is_unsigned_integer<TypeT>::value;

template <typename TypeT>
PHI_INLINE_VARIABLE PHI_CONSTEXPR bool is_not_unsigned_integer_v =
