...
struct is_unsafe_arithmetic
    : public integral_constant<bool, is_unsafe_integral<TypeT>::value ||
                                             is_unsafe_floating_point<TypeT>::value>
{};

template <typename TypeT>
struct is_not_unsafe_arithmetic
    : public integral_constant<bool, !is_unsafe_arithmetic<TypeT>::value>
{};

#if PHI_HAS_FEATURE_VARIABLE_TEMPLATE()

template <typename TypeT>
PHI_INLINE_VARIABLE PHI_CONSTEXPR bool is_unsafe_arithmetic_v = is_unsafe_arithmetic<TypeT>::value;

template <typename TypeT>
PHI_INLINE_VARIABLE PHI_CONSTEXPR bool is_not_unsafe_arithmetic_v =
