...
template <typename TypeT>
PHI_INLINE_VARIABLE PHI_CONSTEXPR bool is_move_assignable_v = is_move_assignable<TypeT>::value;

template <typename TypeT>
PHI_INLINE_VARIABLE PHI_CONSTEXPR bool is_not_move_assignable_v =
        is_not_move_assignable<TypeT>::value;
