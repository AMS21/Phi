...
struct is_safe_type : public integral_constant<bool, is_safe_bool<TypeT>::value ||
                                                             is_safe_floating_point<TypeT>::value ||
                                                             is_safe_integer<TypeT>::value>
{};

template <typename TypeT>
struct is_not_safe_type : public integral_constant<bool, !is_safe_type<TypeT>::value>
{};

#if PHI_HAS_FEATURE_VARIABLE_TEMPLATE()

template <typename TypeT>
PHI_INLINE_VARIABLE PHI_CONSTEXPR bool is_safe_type_v = is_safe_type<TypeT>::value;

template <typename TypeT>
PHI_INLINE_VARIABLE PHI_CONSTEXPR bool is_not_safe_type_v = is_not_safe_type<TypeT>::value;
