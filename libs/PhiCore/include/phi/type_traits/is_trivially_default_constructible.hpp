...
template <typename TypeT>
PHI_INLINE_VARIABLE PHI_CONSTEXPR bool is_trivially_default_constructible_v =
        is_trivially_default_constructible<TypeT>::value;

template <typename TypeT>
PHI_INLINE_VARIABLE PHI_CONSTEXPR bool is_not_trivially_default_constructible_v =
