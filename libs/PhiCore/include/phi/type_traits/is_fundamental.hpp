...
template <typename TypeT>
PHI_INLINE_VARIABLE PHI_CONSTEXPR bool is_fundamental_v = is_fundamental<TypeT>::value;

template <typename TypeT>
PHI_INLINE_VARIABLE PHI_CONSTEXPR bool is_not_fundamental_v = is_not_fundamental<TypeT>::value;
