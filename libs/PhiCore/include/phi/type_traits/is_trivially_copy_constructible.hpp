...
struct is_not_trivially_copy_constructible
    : public integral_constant<bool, !is_trivially_copy_constructible<TypeT>::value>
{};

#if PHI_HAS_FEATURE_VARIABLE_TEMPLATE()

template <typename TypeT>
PHI_INLINE_VARIABLE PHI_CONSTEXPR bool is_trivially_copy_constructible_v =
        is_trivially_copy_constructible<TypeT>::value;

template <typename TypeT>
PHI_INLINE_VARIABLE PHI_CONSTEXPR bool is_not_trivially_copy_constructible_v =
