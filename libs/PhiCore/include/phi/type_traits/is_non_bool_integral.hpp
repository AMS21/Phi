...
template <typename TypeT>
PHI_INLINE_VARIABLE constexpr bool is_non_bool_integral_v = is_non_bool_integral<TypeT>::value;

template <typename TypeT>
PHI_INLINE_VARIABLE constexpr bool is_not_non_bool_integral_v =
