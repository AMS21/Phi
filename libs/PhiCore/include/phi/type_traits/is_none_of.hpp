...
struct is_none_of<CheckT, FirstT, SecondT, RestT...>
    : public bool_constant<
              is_same<CheckT, FirstT>::value ? false : is_none_of<CheckT, SecondT, RestT...>::value>
{};

#if PHI_HAS_FEATURE_VARIABLE_TEMPLATE()

template <typename CheckT, typename FirstT, typename... RestT>
PHI_INLINE_VARIABLE constexpr bool is_none_of_v = is_none_of<CheckT, FirstT, RestT...>::value;
