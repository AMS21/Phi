...
template <typename TypeT>
PHI_INLINE_VARIABLE PHI_CONSTEXPR bool is_safe_integer_v = is_safe_integer<TypeT>::value;

template <typename TypeT>
PHI_INLINE_VARIABLE PHI_CONSTEXPR bool is_not_safe_integer_v = is_not_safe_integer<TypeT>::value;
