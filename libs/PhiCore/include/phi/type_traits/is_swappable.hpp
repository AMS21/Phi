...
template <typename TypeT>
PHI_INLINE_VARIABLE constexpr bool is_swappable_v = is_swappable<TypeT>::value;

template <typename TypeT>
PHI_INLINE_VARIABLE constexpr bool is_not_swappable_v = is_not_swappable<TypeT>::value;
