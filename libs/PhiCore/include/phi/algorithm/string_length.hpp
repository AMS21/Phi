...
PHI_NODISCARD PHI_ATTRIBUTE_PURE constexpr usize string_length(nullptr_t) noexcept
{
    return 0u;
}

template <typename CharT>
PHI_NODISCARD PHI_ATTRIBUTE_PURE PHI_EXTENDED_CONSTEXPR usize string_length(CharT* string,
...
template <typename CharT = nullptr_t>
PHI_NODISCARD PHI_ATTRIBUTE_PURE constexpr usize string_length(nullptr_t,
                                                               PHI_UNUSED usize length) noexcept
{
    return 0u;
}
