...
namespace detail
{
    ...
    PHI_NODISCARD PHI_ALWAYS_INLINE PHI_CONSTEXPR i32 signum_impl(TypeT value,
...
template <typename TypeT>
PHI_NODISCARD PHI_ALWAYS_INLINE PHI_CONSTEXPR i32 signum(TypeT value) noexcept
{
