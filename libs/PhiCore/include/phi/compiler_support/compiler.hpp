...
#    define PHI_COMPILER_CHEERP() 1
// TODO: Find a way to get cheerp version
#    define PHI_CHEERP_VERSION_MAJOR() 1
#    define PHI_CHEERP_VERSION_MINOR() 0
#    define PHI_CHEERP_VERSION_PATCH() 0
#else
#    define PHI_COMPILER_CHEERP()      0
#    define PHI_CHEERP_VERSION_MAJOR() 0
#    define PHI_CHEERP_VERSION_MINOR() 0
#    define PHI_CHEERP_VERSION_PATCH() 0
#endif
...
#elif PHI_COMPILER_IS(CHEERP)
#    define PHI_COMPILER_NAME()                  "Cheerp"
#    define PHI_CURRENT_COMPILER_VERSION()       PHI_COMPILER_VERSION(CHEERP)
#    define PHI_CURRENT_COMPILER_VERSION_MAJOR() PHI_COMPILER_VERSION_MAJOR(CHEERP)
#    define PHI_CURRENT_COMPILER_VERSION_MINOR() PHI_COMPILER_VERSION_MINOR(CHEERP)
#    define PHI_CURRENT_COMPILER_VERSION_PATCH() PHI_COMPILER_VERSION_PATCH(CHEERP)
#else
