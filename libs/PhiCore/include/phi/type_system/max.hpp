...
namespace type_system
{
    namespace detail
    {
        ...
        {
            static constexpr TypeT value = TypeT(127LL);
        };

        template <typename TypeT>
        struct signed_int_max_impl<TypeT, 2u>
        {
            static constexpr TypeT value = TypeT(32767LL);
        };

        template <typename TypeT>
        struct signed_int_max_impl<TypeT, 4u>
        {
            static constexpr TypeT value = TypeT(2147483647LL);
        };

        template <typename TypeT>
        struct signed_int_max_impl<TypeT, 8u>
        {
            static constexpr TypeT value = TypeT(9223372036854775807LL);
        };
        ...
        {
            static constexpr TypeT value = TypeT(255ULL);
        };

        template <typename TypeT>
        struct unsigned_int_max_impl<TypeT, 2u>
        {
            static constexpr TypeT value = TypeT(65535ULL);
        };

        template <typename TypeT>
        struct unsigned_int_max_impl<TypeT, 4u>
        {
            static constexpr TypeT value = TypeT(4294967295ULL);
        };

        template <typename TypeT>
        struct unsigned_int_max_impl<TypeT, 8u>
        {
            static constexpr TypeT value = TypeT(18446744073709551615ULL);
        };
        ...
        {
            static constexpr TypeT value = TypeT(3.4028234e+38f);
        };

        template <typename TypeT>
        struct float_max_impl<TypeT, 8u>
        {
            static constexpr TypeT value = TypeT(1.7976931348623157e+308);
        };
...
#    if PHI_COMPILER_IS(EMCC)
            static constexpr TypeT value = TypeT(1.18973149535723176508575932662800702e+4932L);
#    else
            static constexpr TypeT value = TypeT(1.18973149535723176502e+4932L);
#    endif
        };
        ...
        template <>
        PHI_NODISCARD constexpr bool max_impl<bool>() noexcept
        {
            return true;
        }
        ...
        template <>
        PHI_NODISCARD constexpr char max_impl<char>() noexcept
        {
        ...
        template <>
        PHI_NODISCARD constexpr wchar_t max_impl<wchar_t>() noexcept
        {
        ...
        template <>
        PHI_NODISCARD constexpr char8_t max_impl<char8_t>() noexcept
        {
        ...
        template <>
        PHI_NODISCARD constexpr char16_t max_impl<char16_t>() noexcept
        {
            return detail::unsigned_int_max_impl<char16_t, 2u>::value;
        }

        template <>
        PHI_NODISCARD constexpr char32_t max_impl<char32_t>() noexcept
        {
        ...
        template <>
        PHI_NODISCARD constexpr unsigned char max_impl<unsigned char>() noexcept
        {
        ...
        template <>
        PHI_NODISCARD constexpr unsigned short max_impl<unsigned short>() noexcept
        {
        ...
        template <>
        PHI_NODISCARD constexpr unsigned max_impl<unsigned>() noexcept
        {
            return detail::unsigned_int_max_impl<unsigned, PHI_TYPE_SYSTEM_SIZEOF_INT()>::value;
        }

        template <>
        PHI_NODISCARD constexpr unsigned long max_impl<unsigned long>() noexcept
        {
        ...
        template <>
        PHI_NODISCARD constexpr unsigned long long max_impl<unsigned long long>() noexcept
        {
        ...
        template <>
        PHI_NODISCARD constexpr float max_impl<float>() noexcept
        {
            return detail::float_max_impl<float, PHI_TYPE_SYSTEM_SIZEOF_FLOAT()>::value;
        }

        template <>
        PHI_NODISCARD constexpr double max_impl<double>() noexcept
        {
            return detail::float_max_impl<double, PHI_TYPE_SYSTEM_SIZEOF_DOUBLE()>::value;
        }

        template <>
        PHI_NODISCARD constexpr long double max_impl<long double>() noexcept
        {
    ...
    template <typename TypeT>
    PHI_NODISCARD constexpr remove_cv_t<TypeT> max() noexcept
    {
