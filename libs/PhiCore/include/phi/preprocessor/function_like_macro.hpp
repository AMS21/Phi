...
**/
#ifndef INCG_PHI_CORE_PREPROCESSOR_FUNCTION_LIKE_MACRO_HPP
#define INCG_PHI_CORE_PREPROCESSOR_FUNCTION_LIKE_MACRO_HPP
...
#endif // INCG_PHI_CORE_PREPROCESSOR_FUNCTION_LIKE_MACRO_HPP
