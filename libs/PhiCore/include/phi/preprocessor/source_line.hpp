...
**/
#ifndef INCG_PHI_CORE_PREPROCESSOR_SOURCE_LINE_HPP
#define INCG_PHI_CORE_PREPROCESSOR_SOURCE_LINE_HPP

#include "phi/preprocessor/stringify.hpp" // PHI_STRINGIFY
...
#endif // INCG_PHI_CORE_PREPROCESSOR_SOURCE_LINE_HPP
