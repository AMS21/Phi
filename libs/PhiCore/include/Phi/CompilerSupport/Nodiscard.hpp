...
#if PHI_CPP_STANDARD_IS_ATLEAST(17) && PHI_COMPILER_IS_ATLEAST(CLANG, 3, 9, 0)
#    define PHI_NODISCARD [[nodiscard]]
#elif PHI_COMPILER_IS(CLANG)
#    define PHI_NODISCARD __attribute__((warn_unused_result))
#elif PHI_CPP_STANDARD_IS_ATLEAST(17) && PHI_COMPILER_IS_ATLEAST(GCC, 7, 0, 0)
#    define PHI_NODISCARD [[nodiscard]]
#elif PHI_COMPILER_IS(GCC)
#    define PHI_NODISCARD __attribute__((warn_unused_result))
#elif PHI_CPP_STANDARD_IS_ATLEAST(17) && PHI_COMPILER_IS_ATLEAST(MSVC, 19, 11, 0)
#    define PHI_NODISCARD [[nodiscard]]
