...
{
public:
    using this_type              = DynamicArray<TypeT>;
    ...
    explicit DynamicArray(size_type size) noexcept
        : m_Size{size}
    ...
    PHI_EXTENDED_CONSTEXPR DynamicArray(const DynamicArray& other) noexcept
    ...
    PHI_EXTENDED_CONSTEXPR DynamicArray(DynamicArray&& other) noexcept
    ...
    PHI_CONSTEXPR_DESTRUCTOR ~DynamicArray() noexcept
    {
        delete[] m_Elements;
    }

    PHI_EXTENDED_CONSTEXPR DynamicArray& operator=(const DynamicArray& other) noexcept
    {
    ...
    PHI_EXTENDED_CONSTEXPR DynamicArray& operator=(DynamicArray&& other) noexcept
    {
        m_Elements = exchange(other.m_Elements, nullptr);
        m_Size     = other.m_Size;
    }
