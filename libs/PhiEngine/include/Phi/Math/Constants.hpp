...
#define DETAIL_PHI_DECLARE_CONSTANT(name, value)                                                   \
    ...
    constexpr inline TypeT CPP_GLUE(name, _v) = unsafe_cast<TypeT>(value);                         \
                                                                                                   \
    constexpr inline f64 name                = CPP_GLUE(name, _v)<f64>;                            \
    constexpr inline f64 CPP_GLUE(name, _64) = CPP_GLUE(name, _v)<f64>;                            \
    constexpr inline f32 CPP_GLUE(name, _32) = CPP_GLUE(name, _v)<f32>
...
DETAIL_PHI_DECLARE_CONSTANT(deg2rad, 0.01745329251L);

DETAIL_PHI_DECLARE_CONSTANT(rad2deg, 57.2957795131L);
